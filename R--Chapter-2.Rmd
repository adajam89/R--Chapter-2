...
# List required packages:
    required_packages <- c("tidyverse", "dplyr", "captioner", "tinytex", "kableExtra", "formattable", "readr")
...
# Captioner:
    ...
    figure_numbering("men_ima_procedure.caption",
                     "Data collection procedure for Mental Imagery Agreement responses.", display = FALSE)
...
```{r raw-data, include=FALSE, cache=FALSE}
####################################################################################################################
##                                                                                                                ##
##    EXPERIMENT 2:                                                                                               ##
##                                                                                                                ##
...
![`r figure_numbering("men_ima_procedure.caption")`](./resources/images/procedure.png)
...
\newpage
\blandscape
```{r spelling-correctionss-table, echo=FALSE, cache=FALSE}
