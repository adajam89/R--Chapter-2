...
## Discussion
The objective of the current study was to establish a new set of ecological photograph stimuli to be taken forward into subsequent recognition memory experiments. Matching items with previously established drawings (and words) would allow for the direct examination of stimuli format on recognition response patterns. 


By sourcing photographs that matched the depictions of the same everyday objects 

wherein each of the concepts depicted has been  across formats
