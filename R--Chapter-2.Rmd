...
A number of variables were calculated prior to analysis. The output variables for the naming responses included 
the most frequent name, 
          ...
          for (i in participant_IDs) {
            ...
            temp_d_prime <- (as_tibble(dprime(n_hit = temp$total_word_hit,    ##  Get number of hits;
                                              ...
                                              adjusted = TRUE))) %>%          ## Adjustments for extreme values 
                                                                              ...
                                                                              ##  recommendations of Hautus(1995).
