...
### *Mental imagery agreement*
Scores of mental imagery agreement were moderate across all items (*M* = `r mean_men_ima`), and were very similar as those obtained in response to the other stimuli formats (see `r table_numbering("exp2--colvsgreynorms--tablecaption", display = "cite")`). Unlike previous studies, however, the items in the current study exhibited colour differences; colour photographs (*M* = `r mean_col_men_ima`) showed significantly higher mental imagery agreement scores than grey photographs (*M* = `r mean_grey_men_ima`), [`r apa__men_ima__ttest$statistic`].
