...
##  Create norms table:
    colvsgreynorms <- tribble( ~"Variable",
        ...
        "Naming accuracy",
            NA, 89.2, 90.3, grey_naming_norms$grey_naming_acc_mean, col_naming_norms$col_naming_acc_mean,
        "SD - Naming accuracy",
            NA, 17.2, 16.9, grey_naming_norms$grey_naming_acc_sd, col_naming_norms$col_naming_acc_sd,
        "Naming agreement (H)",
            0.56, 0.38, 0.32, grey_naming_norms$grey_H_mean, col_naming_norms$col_H_mean,
        "SD - Naming agreement (H)",
            0.53, 0.52, 0.46, grey_naming_norms$grey_H_sd, col_naming_norms$col_H_sd,
        "Mental imagery agreement",
            3.69, 3.76, 3.74, grey_men_ima_means$grey_menima_mean, col_men_ima_means$col_menima_mean,
        "SD - Mental imagery agreement",
            0.59, 0.55, 0.63, grey_men_ima_means$grey_menima_sd, col_men_ima_means$col_menima_sd,
        "Familiarity",
            3.29, 3.52, 3.44, grey_fam_means$grey_fam_mean, col_fam_means$col_fam_mean,
        "SD - Familiarity",
            0.96, 1.01, 1.007, grey_fam_means$grey_fam_sd, col_fam_means$col_fam_sd,
        "Visual complexity",
            2.96, 2.88, 2.70, grey_vis_com_means$grey_vis_com_mean, col_vis_com_means$col_vis_com_mean,
        "SD - Visual complexity",
            0.90, 1.03, 0.94, grey_vis_com_means$grey_vis_com_sd, col_vis_com_means$col_vis_com_sd,
        "Colour diagnosticity",
...
```{r define-exp2--colvsgreynorms--tablecaption, echo=FALSE, results = FALSE, cache=FALSE}
    table_numbering(name = "exp2--colvsgreynorms--tablecaption",
                     caption = "Summary statistics (mean and *SD*) for each of the measured variables, 
                                sby colour and greyscale items.")
```
...
```{r, echo=FALSE, cache=FALSE}
  colvsgreynorms_table %>%
      kable("latex", booktabs = T, align = "cccccc", #col.names = NULL,
            linesep = c("", "\\addlinespace", "\\addlinespace", "\\addlinespace", "\\addlinespace")) %>%
      kable_styling(latex_options = "hold_position") %>%
      add_header_above(c(" " = 1, "S+V" = 1, "R+P" = 2, "Current" = 2)) %>%
...
### *Mental imagery agreement*
Scores of mental imagery agreement were moderate across all items (*M* = `r mean_men_ima`), and consistent with previous scores obtained in response to line-drawn stimuli (see `r table_numbering("exp2--colvsgreynorms--tablecaption", display = "cite")`). Unlike previous studies, however, the items in the current study exhibited colour differences; colour photographs (*M* = `r mean_col_men_ima`) showed significantly higher mental imagery agreement scores than grey photographs (*M* = `r mean_grey_men_ima`), [`r apa__men_ima__ttest$statistic`].
