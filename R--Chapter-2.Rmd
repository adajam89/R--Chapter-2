...
will act as a precursor to the planned recognition memory experiments, and will seek to determine which of the three photograph variations we have already selected for each item most closely resembles the depiction in the line drawings by Rossion and Pourtois (2004). We aim to achieve this by gathering normative data for all of the newly-obtained photographs, and then comparing this to the existing normative data for the line drawings, in order to select the most suitable photograph variations to take forward into the proposed memory experiments. 
