...
raw_data <- map_dfr(raw_data_files,~read_csv(.x, col_types = cols_only("date"='c',"expName"='c',"Prolific_ID"='c',
  ...
  select(id, date, exp_ver, usingmac,	retinascreen, age, gender, englishfirstlang, ethnicity, 
         ...
         colourdiagnosticity, mentalimageryagreement, naming_rt, fam_rt, viscom_rt, coldia_rt, menima_rt) %>%
...
####################################################################################################################
##   Mental imagery agreement t-test:                                                                             ##
####################################################################################################################    
...
```{r, echo=FALSE, cache=TRUE}
  colvsgreynorms_table %>%
      ...
      kable_styling(latex_options = "hold_position") %>%
      #add_header_above(c(" ", "Grey" = 2, "", "Colour" = 2)) %>%
...
(*M* = `r mean_men_ima`),
grey (*M* = `r mean_grey_men_ima`),
colour (*M* = `r mean_col_men_ima`),
[`r apa__men_ima__ttest$statistic`]
