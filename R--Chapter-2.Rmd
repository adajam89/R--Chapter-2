...
##  Create norms table:
    colvsgreynorms <- tribble( ~"Variable", ~"Grey", ~"grey_sd", ~"blank", ~"Colour", ~"col_sd",
        "Naming accuracy",
            grey_naming_norms$grey_naming_acc_mean, grey_naming_norms$grey_naming_acc_sd, "",
            col_naming_norms$col_naming_acc_mean, col_naming_norms$col_naming_acc_sd,
        "Naming agreement (H)", 
            grey_naming_norms$grey_H_mean, grey_naming_norms$grey_H_sd, "",
            col_naming_norms$col_H_mean, col_naming_norms$col_H_sd,
        "Mental imagery agreement", 
        ...
        "Visual complexity",
            grey_vis_com_means$grey_vis_com_mean, grey_vis_com_means$grey_vis_com_sd, "",
            col_vis_com_means$col_vis_com_mean,  col_vis_com_means$col_vis_com_sd,
        "Colour diagnosticity",
            NA, NA,"",
            col_dia_means$col_coldia_mean, col_dia_means$col_coldia_sd)
