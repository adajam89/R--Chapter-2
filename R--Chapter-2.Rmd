...
```{r define-grey__dprime_interaction_figure_caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "grey__dprime_interaction_figure_caption",
                     caption = "Interaction plot between stimuli format and response-option for d' scores.")
```

```{r define-grey__PROP.REC.FAM.GUESS.HITS__figure.caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "grey__PROP.REC.FAM.GUESS.HITS__figure.caption",
...
```{r define-grey__PROP.REC.HITS__figure.caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "grey__PROP.REC.HITS__figure.caption",
...
```{r define-grey__PROP.FAM.HITS__figure.caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "grey__PROP.FAM.HITS__figure.caption",
                     caption = "Interaction plot between stimuli format and response-option for the mean proportion of hits assigned 'Familiarity'.")
```

```{r define-grey__PROP.REC.FAM.GUESS.FA__figure.caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "grey__PROP.REC.FAM.GUESS.FA__figure.caption",
                     caption = "Proportion of FAs assigned Recollection, Familiarity, and Guessing, by stimuli format and response-option condition.")
```

```{r define-grey__PROP.FAM.FA__figure.caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "grey__PROP.FAM.FA__figure.caption",
                     caption = "Interaction plot between stimuli format and response-option for the mean proportion of FAs assigned 'Familiarity'.")
```

```{r define-col__PROP.REC.FAM.GUESS.HITS__figure.caption, echo=FALSE, results = FALSE}
    figure_numbering(name = "col__PROP.REC.FAM.GUESS.HITS__figure.caption",
                     caption = "Proportion of hits assigned Recollection, Familiarity, and Guessing, by stimuli format and response-option condition.")
```
...
Many experiments utilise line-drawn illustrations for their picture stimuli [@vandermeulen2012; @westerberg2013; @wolk2011] - a set of items published by @snodgrass1980 are perhaps among the most-used illustrated picture stimuli, at least within the domain of memory research [@weldon1987; @weldon1989; @wagner1997; @whitehouse2006; @vandermeulen2012; @wammes2016]
...
Normative data for the @snodgrass1980 items has been continually revisited, including additional testing of the relationship between reaction time and naming agreement [@szekely2003], as well gathering localised norms for use across different cultures - for example, China [@yoon2004] and Russia (@tsaparina2011). The popularity of the stimuli within cognitive research led to a revision of the items by @rossion2004, whereby each item was carefully re-drawn 
A notable addition to 


The @rossion2004 revision now appears to be favoured over the original @snodgrass1980 set among cognitive researchers [@wolk2008]


while others use photographs [@embree2012; @pitarque2016; @troyer2012; @troyer2016; @wang2013a]. Methodological differences make it difficult to reconcile the effects of drawing vs. photograph. It is unclear whether the magnitude of picture superiority effects are mediated by the format pictures are presented in, and 


While similar sets of photograph stimuli have been published @viggiano2004
@moreno-martinez2012

"visually poor from an ecological point of view"
...
```{r norms-table, include=FALSE, warning = FALSE, message=FALSE, cache=FALSE}
    norms <- raw_data %>%
        ...
        mutate_at(c("familiarity", "visualcomplexity", "colourdiagnosticity", 
                    "mentalimageryagreement"), round, 2)
...
```{r norms-table-print, echo=FALSE, cache=TRUE}
    norms %>%
      kable("latex", longtable = T, booktabs = T, linesep = c("", "", "", "", "", "\\hline")) %>%
