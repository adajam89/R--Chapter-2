...
A secondary aim is to explore the role of colour in the previously established photo superiority effect (PhSE). Within *Experiment 3* (greyscale pictures) and *Experiment 4* (colour pictures), photographs produced clear recognition benefits over line drawings. In both studies, photograph items produced a significantly higher proportion of hits, lower proportion of FAs, and higher *d'* scores than drawings. Such findings were interpreted within a distinctiveness framework, whereby increased item-to-item variability between the more detailed photograph items increased their memorability in comparison to simpler line drawings. However, since analyses could only be performed between drawings and photographs of the same colour modality (i.e. i) drawings without vs. photographs without in *Experiment 3*; and ii) drawings with vs. photographs with in *Experiment 4*) the role of colour in the PhSE is not entirely clear.

While visual inspection of results between *Experiment 3* and *Experiment 4* showed little difference with regard to overall patterns (both showed a PSE, PhSE, and similar patterns of RFG responding), suggesting a negligable effect of colour 


In the same way the PSE was eliminated by @ensor2019b when comparing drawings and distinctive words, if colour information 
