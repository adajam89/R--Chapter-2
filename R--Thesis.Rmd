...
```{r fig.width=5, fig.height=6.4, echo=FALSE, warning = FALSE, message=FALSE, cache=TRUE}
      grid.arrange(exp3.vs.exp4__rec.hits, 
                   exp3.vs.exp4__fam.hits, 
                   exp3.vs.exp4__guess.hits, nrow=3, top = textGrob("Mean proportion of hits"))
```
