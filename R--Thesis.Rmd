...
2. Picture superiority will be evident in each of the response option conditions (RFG, RFBG, RF-Ratings).
    + There will be differences in the way the PSE manifests (e.g. increased recollection, or increased familiarity, in comparison to words) depending upon the response options available to participants (RFG, RFBG, RF-Ratings).
    + When participants have the option to report the co-occurrence of recollection and familiarity (RFBG, RF-Ratings), picture superiority may manifest as an increase to both recollection and familiarity processes. 
...
```{r, include=FALSE, warning = FALSE, message=FALSE, cache=TRUE}
        ...
        exp1__hit.FA.recog.table <- tribble(
          ~"Stim", ~"d'" ~"Hits",  ~"FAs", ~"Overall recognition",
          "Words", 
