...
for (i in exp3and4__participant_IDs) {
  ...
  exp3and4__temp_d_prime <- (as_tibble(dprime(n_hit = exp3and4__temp$total_word_hit,    ##  Get number of hits;
    ...
    ##  are made following the recommendations of Hautus(1995).
...
```{r, include=FALSE, warning = FALSE, message=FALSE, cache=TRUE}
        exp4__RFG__totals <- exp4__colour_data %>% 
            ...
            select(total_hits, total_miss, total_FA, total_CR, 
                   word_d_prime, drawing_d_prime, photo_d_prime, word_c, drawing_c, photo_c) %>%
      ...
      exp4__hit.FA.recog.table <- tribble(
          ~"Stim", ~"d'", ~"c", ~"Hits",  ~"FAs", ~"Overall recognition",
          "Words",        mean(exp4__colour_data$word_d_prime),
                              mean(exp4__colour_data$word_c),
                                  mean(exp4__colour_data$prop_word_hit), 
                                      mean(exp4__colour_data$prop_word_FA),
                                          mean(exp4__colour_data$word_recog),
          "Drawings",     mean(exp4__colour_data$drawing_d_prime),
                              mean(exp4__colour_data$drawing_c),
                                  mean(exp4__colour_data$prop_drawing_hit), 
                                      mean(exp4__colour_data$prop_drawing_FA),
                                          mean(exp4__colour_data$drawing_recog),
          "Photographs",  mean(exp4__colour_data$photo_d_prime),
                              mean(exp4__colour_data$photo_c),
                                  mean(exp4__colour_data$prop_photo_hit), 
                                      mean(exp4__colour_data$prop_photo_FA),
                                          mean(exp4__colour_data$photo_recog),
          "RFG",          mean(exp4__RFG__totals$total_d_prime),
                              mean(exp4__RFG__totals$total_c),
                                  mean(exp4__RFG__totals$prop_RFG_hit),
                                      mean(exp4__RFG__totals$prop_RFG_FA),
                                          mean(exp4__RFG__totals$prop_RFG_recog),
          "RFBG",         mean(exp4__RFBG__totals$total_d_prime),
                              mean(exp4__RFBG__totals$total_c),         
                                  mean(exp4__RFBG__totals$prop_RFBG_hit),
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp4__hit.FA.recog.table", caption = "Mean *d'* (sensitivity), *c* (decision criterion), proportion of hits, FAs, and overall recognition by stimuli-format and response-option condition.", display = FALSE)
```
...
##    Stimuli format:
      ...
      exp4__anova_d_prime_word_photo_emmeans <- exp4__anova_d_prime_stim_format_emmeans[-2]
          exp4__anova_d_prime_word_photo_pairwise <- pairs(exp4__anova_d_prime_word_photo_emmeans,
                                                           adjust = "bonferroni")  
...
##    Stim format pairwise:
      ...
      exp4__words_d_prime_mean <- exp4__apa_anova_d_prime_stim_format_emmeans$estimate$Words %>%
                                      str_remove("\\,.*")
      ...
      exp4__photos_d_prime_mean <- exp4__apa_anova_d_prime_stim_format_emmeans$estimate$Photographs %>%
                                      str_remove("\\,.*")
      exp4__apa_anova_d_prime_word_photo_pairwise <- 
          papaja:::apa_print.emmGrid(exp4__anova_d_prime_word_photo_pairwise)
      exp4__word_photo_d_prime_ttest <- 
          exp4__apa_anova_d_prime_word_photo_pairwise$statistic$Words_Photographs
...
#------------------------------------------------------------------------------------------------------------------
      exp4__ANOVA.table <- tribble(
          ~"", ~"Main effect of stimuli format", ~"Drawings $M = $", ~"Photos *M*=",  ~"Pairwise",
          "d'",                   exp4__apa_anova_d_prime__stim_format,
                                  exp4__drawings_d_prime_mean %>% str_remove(., "M = "),
                                  exp4__photos_d_prime_mean %>% str_remove(., "M = "),
                                  exp4__drawings_photo_d_prime_ttest,
          "c",                    exp4__apa_anova_c__stim_format,
                                  exp4__drawings_c_mean %>% str_remove(., "M = "),
                                  exp4__photos_c_mean %>% str_remove(., "M = "),
                                  exp4__drawings_photo_c_ttest,
          "Proportion of hits",   exp4__apa_anova_prop_hit__stim_format,
                                  exp4__drawings_prop_hit_mean %>% str_remove(., "M = "),
                                  exp4__photos_prop_hit_mean %>% str_remove(., "M = "),
                                  exp4__drawings_photo_hit_ttest, 
          "Proportion of FAs",    exp4__apa_anova_prop_FA__stim_format,
                                  exp4__drawings_prop_FA_mean %>% str_remove(., "M = "),
                                  exp4__photos_prop_FA_mean %>% str_remove(., "M = "),
                                  exp4__drawings_photo_FA_ttest,
          "Overall recognition",  exp4__apa_anova_recog__stim_format,
                                  exp4__drawings_recog_mean %>% str_remove(., "M = "),
                                  exp4__photos_recog_mean %>% str_remove(., "M = "),
                                  exp4__drawings_photo_recog_ttest)
```
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp4__ANOVA.table", caption = "ANOVA results for the main effects of stimuli format on a number of outcome variables.", display = FALSE)
```
...
```{r, echo=FALSE, cache=FALSE}
    exp4__ANOVA.table %>%
        kable("latex", booktabs = T, align = "llccl", escape = F) %>%
...
##    Guess hits:
      exp3__prop_drawing_hit_guess <- exp3__grey_data %>%
...
##    Rec FAs:
      exp3__prop_drawing_FA_rec <- exp3__grey_data %>%
...
##    Fam FAs:
      exp3__prop_drawing_FA_fam <- exp3__grey_data %>%
...
##    Guess FAs:
      exp3__prop_drawing_FA_guess <- exp3__grey_data %>%
      ...
      exp3.vs.exp4__guess.hits <- ggplot(exp3.vs.exp4__guess.hits.data, aes(x=Hits,y=Response,fill = Response))+
        ...
        exp3.vs.exp4__fam.FAs <- ggplot(exp3.vs.exp4__fam.FAs.data, aes(x=FAs,y=Response,fill = Response))+
          ...
          theme(
              ...
              plot.background = element_rect(size = 0.5, linetype = 'solid', colour = "black"),
              plot.margin = margin(20, 20, 24, 30))
      exp3.vs.exp4__guess.FAs <- ggplot(exp3.vs.exp4__guess.FAs.data, aes(x=FAs,y=Response, 
...
exp5__hit_and_miss_calc_function <- function(x){
  ...
  x <- x %>%
    ...
    ##  Distinctive words:
    add_tally(str_detect(stim, "distinctive-word") & response != "new",sort = FALSE, name = "hit__col.word") %>%
    add_tally(str_detect(stim, "distinctive-word") & response == "new",sort = FALSE, name = "miss__col.word") %>%
    ##  Grey drawings:
    add_tally(str_detect(stim, "grey-drawing") & response != "new",sort = FALSE, name = "hit__grey.drawing") %>%
    add_tally(str_detect(stim, "grey-drawing") & response == "new",sort = FALSE, name = "miss__grey.drawing") %>%
    ##  Col drawings:
    add_tally(str_detect(stim, "col-drawing") & response != "new",sort = FALSE, name = "hit__col.drawing") %>%
    add_tally(str_detect(stim, "col-drawing") & response == "new",sort = FALSE, name = "miss__col.drawing") %>%
    ##  Grey photos:
    ...
    ##  Count stim-format totals by response option:
    ##  Grey words:
    add_tally(str_detect(stim, "grey-word") & response == "recollection", sort = FALSE, name = "hit.R__grey.word") %>%
    add_tally(str_detect(stim, "grey-word") & response == "familiarity", sort = FALSE, name = "hit.F__grey.word") %>%
    add_tally(str_detect(stim, "grey-word") & response == "guessing", sort = FALSE, name = "hit.G__grey.word") %>%
    ##  Distinctive words:
    add_tally(str_detect(stim, "distinctive-word") & response == "recollection", sort = FALSE, name = "hit.R__col.word") %>%
    add_tally(str_detect(stim, "distinctive-word") & response == "familiarity", sort = FALSE, name = "hit.F__col.word") %>%
    add_tally(str_detect(stim, "distinctive-word") & response == "guessing", sort = FALSE, name = "hit.G__col.word") %>%
    ##  Grey drawings:
    add_tally(str_detect(stim, "grey-drawing") & response == "recollection", sort = FALSE, name = "hit.R__grey.drawing") %>%
    add_tally(str_detect(stim, "grey-drawing") & response == "familiarity", sort = FALSE, name = "hit.F__grey.drawing") %>%
    add_tally(str_detect(stim, "grey-drawing") & response == "guessing", sort = FALSE, name = "hit.G__grey.drawing") %>%
    ##  Col drawings:
    add_tally(str_detect(stim, "col-drawing") & response == "recollection", sort = FALSE, name = "hit.R__col.drawing") %>%
    add_tally(str_detect(stim, "col-drawing") & response == "familiarity", sort = FALSE, name = "hit.F__col.drawing") %>%
    add_tally(str_detect(stim, "col-drawing") & response == "guessing", sort = FALSE, name = "hit.G__col.drawing") %>%
    ##  Grey photos:
    add_tally(str_detect(stim, "grey-photo") & response == "recollection", sort = FALSE, name = "hit.R__grey.photo") %>%
    add_tally(str_detect(stim, "grey-photo") & response == "familiarity", sort = FALSE, name = "hit.F__grey.photo") %>%
    add_tally(str_detect(stim, "grey-photo") & response == "guessing", sort = FALSE, name = "hit.G__grey.photo") %>%
    ##  Col photos:
    add_tally(str_detect(stim, "col-photo") & response == "recollection", sort = FALSE, name = "hit.R__col.photo") %>%
    add_tally(str_detect(stim, "col-photo") & response == "familiarity", sort = FALSE, name = "hit.F__col.photo") %>%
    add_tally(str_detect(stim, "col-photo") & response == "guessing", sort = FALSE, name = "hit.G__col.photo")}
...
exp5__FA_and_CR_calc_function <- function(x){
  ...
  x <- x %>%
    ...
    ##  Count stim-format totals by response option:
    ##  Grey words:
    add_tally(str_detect(stim, "grey-word") & response == "recollection", sort = FALSE,name = "FA.R__grey.word") %>%
    add_tally(str_detect(stim, "grey-word") & response == "familiarity", sort = FALSE,name = "FA.F__grey.word") %>%
    add_tally(str_detect(stim, "grey-word") & response == "guessing", sort = FALSE,name = "FA.G__grey.word") %>%
    ##  Distinctive words:
    add_tally(str_detect(stim, "distinctive-word") & response == "recollection", sort = FALSE, name = "FA.R__col.word") %>%
    add_tally(str_detect(stim, "distinctive-word") & response == "familiarity", sort = FALSE, name = "FA.F__col.word") %>%
    add_tally(str_detect(stim, "distinctive-word") & response == "guessing", sort = FALSE, name = "FA.G__col.word") %>%
    ##  Grey drawings:
    add_tally(str_detect(stim, "grey-drawing") & response == "recollection", sort = FALSE,name = "FA.R__grey.drawing") %>%
    add_tally(str_detect(stim, "grey-drawing") & response == "familiarity", sort = FALSE,name = "FA.F__grey.drawing") %>%
    add_tally(str_detect(stim, "grey-drawing") & response == "guessing", sort = FALSE,name = "FA.G__grey.drawing") %>%
    ##  Col drawings:
    add_tally(str_detect(stim, "col-drawing") & response == "recollection", sort = FALSE,name = "FA.R__col.drawing") %>%
    add_tally(str_detect(stim, "col-drawing") & response == "familiarity", sort = FALSE,name = "FA.F__col.drawing") %>%
    add_tally(str_detect(stim, "col-drawing") & response == "guessing", sort = FALSE,name = "FA.G__col.drawing") %>%
    ##  Grey photos:
    add_tally(str_detect(stim, "grey-photo") & response == "recollection", sort = FALSE,name = "FA.R__grey.photo") %>%
    add_tally(str_detect(stim, "grey-photo") & response == "familiarity", sort = FALSE,name = "FA.F__grey.photo") %>%
    add_tally(str_detect(stim, "grey-photo") & response == "guessing", sort = FALSE,name = "FA.G__grey.photo") %>%
    ##  Col photos:
    add_tally(str_detect(stim, "col-photo") & response == "recollection", sort = FALSE,name = "FA.R__col.photo") %>%
    add_tally(str_detect(stim, "col-photo") & response == "familiarity", sort = FALSE,name = "FA.F__col.photo") %>%
    add_tally(str_detect(stim, "col-photo") & response == "guessing", sort = FALSE,name = "FA.G__col.photo")}  
...
##    HITS - FAs = overall measure of recognition:
  ...
  #mutate(classic_z_hit_word = (total_word_hit - mean(total_word_hit)) / sd(total_word_hit)) %>%
  #mutate(classic_z_FA_word = (total_word_FA - mean(total_word_FA)) / sd(total_word_FA)) %>%
  #mutate(classic_z_hit_drawing = (total_drawinhit.G__total - mean(total_drawinhit.G__total)) / 
  #sd(total_drawinhit.G__total)) %>%
  #mutate(classic_z_FA_drawing = (total_drawinFA.G__total - mean(total_drawinFA.G__total)) / sd(total_drawinFA.G__total)) %>%
  #mutate(classic_z_hit_photo = (total_photo_hit - mean(total_photo_hit)) / sd(total_photo_hit)) %>%
  #mutate(classic_z_FA_photo = (total_photo_FA - mean(total_photo_FA)) / sd(total_photo_FA)) %>%
  ...
  mutate("z.hit__grey.word" = qnorm((hit__grey.word + 0.5) / 
                                           (hit__grey.word + miss__grey.word + 1))) %>%
  mutate("z.FA__grey.word" = qnorm((FA__grey.word + 0.5) / 
                                          (FA__grey.word + CR__grey.word + 1))) %>%
  mutate("z.hit__col.word" = qnorm((hit__col.word + 0.5) / 
                                                  (hit__col.word + miss__col.word + 1))) %>%
  mutate("z.FA__col.word" = qnorm((FA__col.word + 0.5) / 
                                                 (FA__col.word + CR__col.word + 1))) %>%
  mutate("z.hit__grey.drawing" = qnorm((hit__grey.drawing + 0.5) / 
                                              (hit__grey.drawing + miss__grey.drawing + 1))) %>%
  mutate("z.FA__grey.drawing" = qnorm((FA__grey.drawing + 0.5) / 
                                             (FA__grey.drawing + CR__grey.drawing + 1))) %>%
  mutate("z.hit__col.drawing" = qnorm((hit__col.drawing + 0.5) / 
                                             (hit__col.drawing + miss__col.drawing + 1))) %>%
  mutate("z.FA__col.drawing" = qnorm((FA__col.drawing + 0.5) / 
                                            (FA__col.drawing + CR__col.drawing + 1))) %>%
  mutate("z.hit__grey.photo" = qnorm((hit__grey.photo + 0.5) / 
                                            (hit__grey.photo + miss__grey.photo + 1))) %>%
  mutate("z.FA__grey.photo" = qnorm((FA__grey.photo + 0.5) / 
                                           (FA__grey.photo + CR__grey.photo + 1))) %>%
  mutate("z.hit__col.photo" = qnorm((hit__col.photo + 0.5) / 
                                           (hit__col.photo + miss__col.photo + 1))) %>%
  mutate("z.FA__col.photo" = qnorm((FA__col.photo + 0.5) / 
                                          (FA__col.photo + CR__col.photo + 1))) %>%
  ##    Grey word accuracy:
  mutate(accuracy.R.raw__grey.word = hit.R__grey.word / (hit.R__grey.word + FA.R__grey.word)) %>%
  mutate(accuracy.F.raw__grey.word = hit.F__grey.word / (hit.F__grey.word + FA.F__grey.word)) %>%
  mutate(accuracy.G.raw__grey.word = hit.G__grey.word / (hit.G__grey.word + FA.G__grey.word)) %>%
  ##    Distinctive word accuracy:
  mutate(accuracy.R.raw__col.word = hit.R__col.word / (hit.R__col.word + FA.R__col.word)) %>%
  mutate(accuracy.F.raw__col.word = hit.F__col.word / (hit.F__col.word + FA.F__col.word)) %>%
  mutate(accuracy.G.raw__col.word = hit.G__col.word / (hit.G__col.word + FA.G__col.word)) %>%          
  ##    Grey drawing accuracy:
  mutate(accuracy.R.raw__grey.drawing = hit.R__grey.drawing / (hit.R__grey.drawing + FA.R__grey.drawing)) %>%
  mutate(accuracy.F.raw__grey.drawing = hit.F__grey.drawing / (hit.F__grey.drawing + FA.F__grey.drawing)) %>%
  mutate(accuracy.G.raw__grey.drawing = hit.G__grey.drawing / (hit.G__grey.drawing + FA.G__grey.drawing)) %>%
  ##    Grey drawing accuracy:
  mutate(accuracy.R.raw__col.drawing = hit.R__col.drawing / (hit.R__col.drawing + FA.R__col.drawing)) %>%
  mutate(accuracy.F.raw__col.drawing = hit.F__col.drawing / (hit.F__col.drawing + FA.F__col.drawing)) %>%
  mutate(accuracy.G.raw__col.drawing = hit.G__col.drawing / (hit.G__col.drawing + FA.G__col.drawing)) %>%
  ##    Grey photo accuracy:
  mutate(accuracy.R.raw__grey.photo = hit.R__grey.photo / (hit.R__grey.photo + FA.R__grey.photo)) %>%
  mutate(accuracy.F.raw__grey.photo = hit.F__grey.photo / (hit.F__grey.photo + FA.F__grey.photo)) %>%
  mutate(accuracy.G.raw__grey.photo = hit.G__grey.photo / (hit.G__grey.photo + FA.G__grey.photo)) %>%
  ##    Col photo accuracy:
  mutate(accuracy.R.raw__col.photo = hit.R__col.photo / (hit.R__col.photo + FA.R__col.photo)) %>%
  mutate(accuracy.F.raw__col.photo = hit.F__col.photo / (hit.F__col.photo + FA.F__col.photo)) %>%
  mutate(accuracy.G.raw__col.photo = hit.G__col.photo / (hit.G__col.photo + FA.G__col.photo)) %>%  
  ##    d'prime (calculated in the same way as we did previously in Excel):
  mutate("OLD.dprime__grey.word" = z.hit__grey.word - z.FA__grey.word) %>%
  mutate("OLD.dprime__col.word" = z.hit__col.word - z.FA__col.word) %>%
  mutate("OLD.dprime__grey.drawing" = z.hit__grey.drawing - z.FA__grey.drawing) %>%
  mutate("OLD.dprime__col.drawing" = z.hit__col.drawing - z.FA__col.drawing) %>%
  mutate("OLD.dprime__grey.photo" = z.hit__grey.photo - z.FA__grey.photo) %>%
  mutate("OLD.dprime__col.photo" = z.hit__col.photo - z.FA__col.photo)
##    d'prime (calculated by R package):
##  List unique participant IDs to loop through:
...
for (i in exp5__participant_IDs) {
  ...
  exp5__temp <- exp5__test_stats %>%
    ...
    filter(id == i) %>%     
    ##  Select only the columns necessary for dprime calculations:
    select(id, hit__grey.word, FA__grey.word, miss__grey.word, CR__grey.word)
  
  exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.word,
                                          n_fa = exp5__temp$FA__grey.word,
                                          n_miss = exp5__temp$miss__grey.word,
                                          n_cr = exp5__temp$CR__grey.word,
                                          n_targets = 10,
                                          n_distractors = 10,
                                          adjusted = TRUE))) %>%
    mutate("id" = i)
  exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
  dprime__grey.word <- bind_rows(dprime__grey.word, exp5__temp) }
##  Additional tidying:     
dprime__grey.word <- dprime__grey.word %>%                                        
  select(id, dprime, beta, aprime, bppd, c) %>%                       # Select only the new columns. 
  rename(dprime__grey.word = "dprime", beta__grey.word = "beta", # Rename these columns to reflect
         aprime__grey.word = "aprime", bppd__grey.word = "bppd",   # the stimulus format.     
         c__grey.word = "c")
#---------------------------------------------------------------------------------------------------------------#
##    Distinctive word d'prime (calculated by R package):
##    Create empty df to store word dprime calculations:
dprime__col.word <- tibble()
##  Initiate for loop that iterates through exp5__participant_IDs:
for (i in exp5__participant_IDs) {
  ...
  exp5__temp <- exp5__test_stats %>%
    ...
    filter(id == i) %>%     
    ##  Select only the columns necessary for dprime calculations:
    select(id, hit__col.word, FA__col.word, miss__col.word,
           CR__col.word)
  
  exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.word,
                                          n_fa = exp5__temp$FA__col.word,
                                          n_miss = exp5__temp$miss__col.word,
                                          n_cr = exp5__temp$CR__col.word,
                                          n_targets = 10,
                                          n_distractors = 10,
                                          adjusted = TRUE))) %>%
    mutate("id" = i)
  exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
  dprime__col.word <- bind_rows(dprime__col.word, exp5__temp) }
##  Additional tidying:     
dprime__col.word <- dprime__col.word %>%
  select(id, dprime, beta, aprime, bppd, c) %>%
  rename(dprime__col.word = "dprime", beta__col.word = "beta",
         aprime__col.word = "aprime", bppd__col.word = "bppd",
         c__col.word = "c")
#---------------------------------------------------------------------------------------------------------------#
##    Grey drawing d'prime (calculated by R package):
##  Create empty df to store word dprime calculations:
dprime__grey.drawing <- tibble()
# Initiate for loop that iterates through exp5__participant_IDs:
for (i in exp5__participant_IDs) {
  ...
  exp5__temp <- exp5__test_stats %>%
    ...
    filter(id == i) %>%     
    # Select only the columns necessary for dprime calculations:
    select(id, hit__grey.drawing, FA__grey.drawing, miss__grey.drawing, CR__grey.drawing)
  
  exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.drawing,
                                          n_fa = exp5__temp$FA__grey.drawing,
                                          n_miss = exp5__temp$miss__grey.drawing,
                                          n_cr = exp5__temp$CR__grey.drawing,
                                          n_targets = 10,
                                          n_distractors = 10,
                                          adjusted = TRUE))) %>%
    mutate("id" = i)
  exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
  dprime__grey.drawing <- bind_rows(dprime__grey.drawing, exp5__temp) }
##    Additional tidying:     
dprime__grey.drawing <- dprime__grey.drawing %>%                                        
  select(id, dprime, beta, aprime, bppd, c) %>%
  rename(dprime__grey.drawing = "dprime", beta__grey.drawing = "beta",
         aprime__grey.drawing = "aprime", bppd__grey.drawing = "bppd",
         c__grey.drawing = "c")
#---------------------------------------------------------------------------------------------------------------###    Colour drawing d'prime (calculated by R package):
##  Create empty df to store word dprime calculations:
dprime__col.drawing <- tibble()
# Initiate for loop that iterates through exp5__participant_IDs:
for (i in exp5__participant_IDs) {
  # Create a exp5__temporary df (that gets overwritten each time the loop iterates), with data from "exp5__test_stats":
  exp5__temp <- exp5__test_stats %>%
    ...
    filter(id == i) %>%     
    # Select only the columns necessary for dprime calculations:
    select(id, hit__col.drawing, FA__col.drawing, miss__col.drawing, CR__col.drawing)
  
  exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.drawing,
                                          n_fa = exp5__temp$FA__col.drawing,
                                          n_miss = exp5__temp$miss__col.drawing,
                                          n_cr = exp5__temp$CR__col.drawing,
                                          n_targets = 10,
                                          n_distractors = 10,
                                          adjusted = TRUE))) %>%
    mutate("id" = i)
  exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
  dprime__col.drawing <- bind_rows(dprime__col.drawing, exp5__temp) }
##    Additional tidying:     
dprime__col.drawing <- dprime__col.drawing %>%                                        
  select(id, dprime, beta, aprime, bppd, c) %>%
  rename(dprime__col.drawing = "dprime", beta__col.drawing = "beta",
         aprime__col.drawing = "aprime", bppd__col.drawing = "bppd",
         c__col.drawing = "c")
#---------------------------------------------------------------------------------------------------------------###  Grey photo d'prime (calculated by R package):
# Create empty df to store word dprime calculations:
dprime__grey.photo <- tibble()
# Initiate for loop that iterates through exp5__participant_IDs:
for (i in exp5__participant_IDs) {
  # Create a exp5__temporary df (that gets overwritten each time the loop iterates), with data from "exp5__test_stats":
  exp5__temp <- exp5__test_stats %>%
    ...
    filter(id == i) %>%     
    # Select only the columns necessary for dprime calculations:
    select(id, hit__grey.photo, FA__grey.photo, miss__grey.photo, CR__grey.photo)
  
  exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.photo,
                                          n_fa = exp5__temp$FA__grey.photo,
                                          n_miss = exp5__temp$miss__grey.photo,
                                          n_cr = exp5__temp$CR__grey.photo,
                                          n_targets = 10,
                                          n_distractors = 10,
                                          adjusted = TRUE))) %>%
    mutate("id" = i)
  exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
  dprime__grey.photo <- bind_rows(dprime__grey.photo, exp5__temp) }
##  Additional tidying:     
dprime__grey.photo <- dprime__grey.photo %>%                                        
  select(id, dprime, beta, aprime, bppd, c) %>% 
  rename(dprime__grey.photo = "dprime", beta__grey.photo = "beta",
         aprime__grey.photo = "aprime", bppd__grey.photo = "bppd",    
         c__grey.photo = "c")
#---------------------------------------------------------------------------------------------------------------###    Colour photo d'prime (calculated by R package):
##    Create empty df to store word dprime calculations:
dprime__col.photo <- tibble()
##    Initiate for loop that iterates through exp5__participant_IDs:
for (i in exp5__participant_IDs) {
  ...
  exp5__temp <- exp5__test_stats %>%
    ...
    filter(id == i) %>%     
    ##    Select only the columns necessary for dprime calculations:
    select(id, hit__col.photo, FA__col.photo, miss__col.photo, CR__col.photo)
  exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.photo,
                                          n_fa = exp5__temp$FA__col.photo,
                                          n_miss = exp5__temp$miss__col.photo,
                                          n_cr = exp5__temp$CR__col.photo,
                                          n_targets = 10,
                                          n_distractors = 10,
                                          adjusted = TRUE))) %>% mutate("id" = i)
  exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
  dprime__col.photo <- bind_rows(dprime__col.photo, exp5__temp) }
##    Additional tidying:     
dprime__col.photo <- dprime__col.photo %>%                                        
  select(id, dprime, beta, aprime, bppd, c) %>%
  rename(dprime__col.photo = "dprime", beta__col.photo = "beta", aprime__col.photo = "aprime",
         bppd__col.photo = "bppd", c__col.photo = "c")
##    Add new d'prime calculations to 'exp5__test_stats' df: 
exp5__test_stats <- exp5__test_stats %>%
  right_join(dprime__grey.word) %>%
  right_join(dprime__col.word) %>%
  right_join(dprime__grey.drawing) %>%
  right_join(dprime__col.drawing) %>%
  right_join(dprime__grey.photo) %>%
  right_join(dprime__col.photo)
...
#----------------------------------------------------------------------------------------------------------------
      exp5__d.prime <- exp5__final_data %>%
          select(id, dprime__grey.word, dprime__col.word, dprime__grey.drawing, dprime__col.drawing, 
                 dprime__grey.photo, dprime__col.photo) %>%
          gather(key = "stim", value = "d.prime", dprime__grey.word, dprime__col.word, dprime__grey.drawing,
                 dprime__col.drawing, dprime__grey.photo, dprime__col.photo) %>%
          mutate(stim = str_remove(stim, "dprime__"))
      exp5__c <- exp5__final_data %>%
          select(id, c__grey.word, c__col.word, c__grey.drawing, c__col.drawing, c__grey.photo, c__col.photo) %>%
          gather(key = "stim", value = "c", c__grey.word, c__col.word, c__grey.drawing, c__col.drawing,
                 c__grey.photo, c__col.photo) %>%
          mutate(stim = str_remove(stim, "c__"))
      exp5__prop.hit <- exp5__final_data %>%
      ...
      exp5__prop.FA <- exp5__final_data %>%
      ...
      exp5__recog <- exp5__final_data %>%
          select(id, recog__grey.word, recog__col.word, recog__grey.drawing, recog__col.drawing, 
                 recog__grey.photo, recog__col.photo) %>%
          gather(key = "stim", value = "recog", recog__grey.word, recog__col.word, recog__grey.drawing,
                 recog__col.drawing,recog__grey.photo, recog__col.photo) %>%
          mutate(stim = str_remove(stim, "recog__"))
      exp5__prop.hit.R <- exp5__final_data %>%
      ...
      exp5__prop.hit.F <- exp5__final_data %>%
          ...
          gather(key = "stim", value = "prop.hit.F", prop.hit.F__grey.word, prop.hit.F__col.word,
                 prop.hit.F__grey.drawing, prop.hit.F__col.drawing,prop.hit.F__grey.photo, 
                 prop.hit.F__col.photo) %>%
          mutate(stim = str_remove(stim, "prop.hit.F__"))
      exp5__prop.hit.G <- exp5__final_data %>%
      ...
      exp5__prop.FA.R <- exp5__final_data %>%
          ...
          gather(key = "stim", value = "prop.FA.R", prop.FA.R__grey.word, prop.FA.R__col.word,
                 prop.FA.R__grey.drawing, prop.FA.R__col.drawing,prop.FA.R__grey.photo, 
                 prop.FA.R__col.photo) %>%
          mutate(stim = str_remove(stim, "prop.FA.R__"))
      exp5__prop.FA.F <- exp5__final_data %>%
          ...
          gather(key = "stim", value = "prop.FA.F", prop.FA.F__grey.word, prop.FA.F__col.word,
                 prop.FA.F__grey.drawing, prop.FA.F__col.drawing,prop.FA.F__grey.photo, 
                 prop.FA.F__col.photo) %>%
          mutate(stim = str_remove(stim, "prop.FA.F__"))
      exp5__prop.FA.G <- exp5__final_data %>%
          ...
          gather(key = "stim", value = "prop.FA.G", prop.FA.G__grey.word, prop.FA.G__col.word,
                 prop.FA.G__grey.drawing, prop.FA.G__col.drawing,prop.FA.G__grey.photo, 
...
##      d-prime (calculated by R package):
##      List unique participant IDs to loop through:
        ensor.exp1.participant_IDs <- unique(ensor.exp1.data$id)
##    d-prime (grey word):
      ensor.exp1.d.prime__grey.word <- tibble()
      for (i in ensor.exp1.participant_IDs) {
          exp5__temp <- ensor.exp1.data %>%
              filter(id == i) %>%     
              select(id, hit__grey.word, FA__grey.word, miss__grey.word, CR__grey.word)
          ...
          exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.word,
              ...
              mutate("id" = i)
          exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
          ensor.exp1.d.prime__grey.word <- bind_rows(ensor.exp1.d.prime__grey.word, exp5__temp) }

        ensor.exp1.d.prime__grey.word <- ensor.exp1.d.prime__grey.word %>%
            select(id, dprime, beta, aprime, bppd, c) %>%
            rename(dprime__grey.word = "dprime", beta__grey.word = "beta",
                   aprime__grey.word = "aprime", bppd__grey.word = "bppd",
                   c__grey.word = "c")
##    d-prime (col word):
      ensor.exp1.d.prime__col.word <- tibble()
      for (i in ensor.exp1.participant_IDs) {
          exp5__temp <- ensor.exp1.data %>%
              filter(id == i) %>%     
              select(id, hit__col.word, FA__col.word, miss__col.word, CR__col.word)
          ...
          exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.word,
              ...
              mutate("id" = i)
          exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
          ensor.exp1.d.prime__col.word <- bind_rows(ensor.exp1.d.prime__col.word, exp5__temp) }

        ensor.exp1.d.prime__col.word <- ensor.exp1.d.prime__col.word %>%
            select(id, dprime, beta, aprime, bppd, c) %>%
            rename(dprime__col.word = "dprime", beta__col.word = "beta",
                   aprime__col.word = "aprime", bppd__col.word = "bppd",
                   c__col.word = "c")
##    d-prime (grey drawing):
      ensor.exp1.d.prime__grey.drawing <- tibble()
      for (i in ensor.exp1.participant_IDs) {
          exp5__temp <- ensor.exp1.data %>%
              filter(id == i) %>%     
              select(id, hit__grey.drawing, FA__grey.drawing, miss__grey.drawing, CR__grey.drawing)
          ...
          exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.drawing,
              ...
              mutate("id" = i)
          exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
          ensor.exp1.d.prime__grey.drawing <- bind_rows(ensor.exp1.d.prime__grey.drawing, exp5__temp) }

        ensor.exp1.d.prime__grey.drawing <- ensor.exp1.d.prime__grey.drawing %>%
            select(id, dprime, beta, aprime, bppd, c) %>%
            rename(dprime__grey.drawing = "dprime", beta__grey.drawing = "beta",
                   aprime__grey.drawing = "aprime", bppd__grey.drawing = "bppd",
                   c__grey.drawing = "c")
##    d-prime (col drawing):
      ensor.exp1.d.prime__col.drawing <- tibble()
      for (i in ensor.exp1.participant_IDs) {
          exp5__temp <- ensor.exp1.data %>%
              filter(id == i) %>%     
              select(id, hit__col.drawing, FA__col.drawing, miss__col.drawing, CR__col.drawing)
          ...
          exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.drawing,
              ...
              mutate("id" = i)
          exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
          ensor.exp1.d.prime__col.drawing <- bind_rows(ensor.exp1.d.prime__col.drawing, exp5__temp) }

      ensor.exp1.d.prime__col.drawing <- ensor.exp1.d.prime__col.drawing %>%
          select(id, dprime, beta, aprime, bppd, c) %>%
          rename(dprime__col.drawing = "dprime", beta__col.drawing = "beta", aprime__col.drawing = "aprime",
                 bppd__col.drawing = "bppd", c__col.drawing = "c")

##    Add d'prime calculations to 'ensor.exp1.data' df: 
      ensor.exp1.data <- ensor.exp1.data %>%
          right_join(ensor.exp1.d.prime__grey.word) %>%
          right_join(ensor.exp1.d.prime__col.word) %>%
          right_join(ensor.exp1.d.prime__grey.drawing) %>%
          right_join(ensor.exp1.d.prime__col.drawing)
#----------------------------------------------------------------------------------------------------------------
#   Prep key data for analysis:
#----------------------------------------------------------------------------------------------------------------  
      ensor.exp1__d.prime <- ensor.exp1.data %>%
          select(id, dprime__grey.word, dprime__col.word, dprime__grey.drawing, dprime__col.drawing) %>%
          gather(key = "stim", value = "d.prime", dprime__grey.word, dprime__col.word,
                 dprime__grey.drawing, dprime__col.drawing) %>%
          mutate(stim = str_remove(stim, "dprime__"))
      ensor.exp1__c <- ensor.exp1.data %>%
          select(id, c__grey.word, c__col.word, c__grey.drawing, c__col.drawing) %>%
          gather(key = "stim", value = "c", c__grey.word, c__col.word, c__grey.drawing, c__col.drawing) %>%
          mutate(stim = str_remove(stim, "c__"))
      ...
      ensor.exp1__prop.FA <- ensor.exp1.data %>%
          ...
          mutate(stim = str_remove(stim, "prop.FA__"))
      ensor.exp1__recog <- ensor.exp1.data %>%
          select(id, recog__grey.word, recog__col.word, recog__grey.drawing, recog__col.drawing) %>%
          gather(key = "stim", value = "recog", recog__grey.word, recog__col.word, recog__grey.drawing,
                 recog__col.drawing) %>%
          mutate(stim = str_remove(stim, "recog__"))
...
#----------------------------------------------------------------------------------------------------------------
      ...
      ##      d-prime (calculated by R package):
      ##      List unique participant IDs to loop through:
      ensor.exp2.participant_IDs <- unique(ensor.exp2.data$id)
##    d-prime (grey word):
      ensor.exp2.d.prime__grey.word <- tibble()
      for (i in ensor.exp2.participant_IDs) {
        exp5__temp <- ensor.exp2.data %>%
          filter(id == i) %>%
          select(id, hit__grey.word, FA__grey.word, miss__grey.word, CR__grey.word)
        ...
        exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.word,
          ...
          mutate("id" = i)
        exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
        ensor.exp2.d.prime__grey.word <- bind_rows(ensor.exp2.d.prime__grey.word, exp5__temp) }
      
      ensor.exp2.d.prime__grey.word <- ensor.exp2.d.prime__grey.word %>%
        select(id, dprime, beta, aprime, bppd, c) %>%
        rename(dprime__grey.word = "dprime", beta__grey.word = "beta",
               aprime__grey.word = "aprime", bppd__grey.word = "bppd",
               c__grey.word = "c")
      ##    d-prime (col word):
      ensor.exp2.d.prime__col.word <- tibble()
      for (i in ensor.exp2.participant_IDs) {
        exp5__temp <- ensor.exp2.data %>%
          filter(id == i) %>%     
          select(id, hit__col.word, FA__col.word, miss__col.word, CR__col.word)
        ...
        exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.word,
          ...
          mutate("id" = i)
        exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
        ensor.exp2.d.prime__col.word <- bind_rows(ensor.exp2.d.prime__col.word, exp5__temp) }
      
      ensor.exp2.d.prime__col.word <- ensor.exp2.d.prime__col.word %>%
        select(id, dprime, beta, aprime, bppd, c) %>%
        rename(dprime__col.word = "dprime", beta__col.word = "beta",
               aprime__col.word = "aprime", bppd__col.word = "bppd",
               c__col.word = "c")
      ##    d-prime (grey drawing):
      ensor.exp2.d.prime__grey.drawing <- tibble()
      for (i in ensor.exp2.participant_IDs) {
        exp5__temp <- ensor.exp2.data %>%
          filter(id == i) %>%     
          select(id, hit__grey.drawing, FA__grey.drawing, miss__grey.drawing, CR__grey.drawing)
        ...
        exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__grey.drawing,
          ...
          mutate("id" = i)
        exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
        ensor.exp2.d.prime__grey.drawing <- bind_rows(ensor.exp2.d.prime__grey.drawing, exp5__temp) }
      
      ensor.exp2.d.prime__grey.drawing <- ensor.exp2.d.prime__grey.drawing %>%
        select(id, dprime, beta, aprime, bppd, c) %>%
        rename(dprime__grey.drawing = "dprime", beta__grey.drawing = "beta",
               aprime__grey.drawing = "aprime", bppd__grey.drawing = "bppd",
               c__grey.drawing = "c")
      ##    d-prime (col drawing):
      ensor.exp2.d.prime__col.drawing <- tibble()
      for (i in ensor.exp2.participant_IDs) {
        exp5__temp <- ensor.exp2.data %>%
          filter(id == i) %>%     
          select(id, hit__col.drawing, FA__col.drawing, miss__col.drawing, CR__col.drawing)
        ...
        exp5__temp_d_prime <- (as_tibble(dprime(n_hit = exp5__temp$hit__col.drawing,
          ...
          mutate("id" = i)
        exp5__temp <- exp5__temp %>% inner_join(exp5__temp_d_prime, by = "id")
        ensor.exp2.d.prime__col.drawing <- bind_rows(ensor.exp2.d.prime__col.drawing, exp5__temp) }
      
      ensor.exp2.d.prime__col.drawing <- ensor.exp2.d.prime__col.drawing %>%
        select(id, dprime, beta, aprime, bppd, c) %>%
        rename(dprime__col.drawing = "dprime", beta__col.drawing = "beta", aprime__col.drawing = "aprime",
               bppd__col.drawing = "bppd", c__col.drawing = "c")
      
      ##    Add d'prime calculations to 'ensor.exp2.data' df: 
      ensor.exp2.data <- ensor.exp2.data %>%
        right_join(ensor.exp2.d.prime__grey.word) %>%
        right_join(ensor.exp2.d.prime__col.word) %>%
        right_join(ensor.exp2.d.prime__grey.drawing) %>%
        right_join(ensor.exp2.d.prime__col.drawing)
#----------------------------------------------------------------------------------------------------------------
#   Prep key data for analysis:
#----------------------------------------------------------------------------------------------------------------  
      ensor.exp2__d.prime <- ensor.exp2.data %>%
        select(id, dprime__grey.word, dprime__col.word, dprime__grey.drawing, dprime__col.drawing) %>%
        gather(key = "stim", value = "d.prime", dprime__grey.word, dprime__col.word,
               dprime__grey.drawing, dprime__col.drawing) %>%
        mutate(stim = str_remove(stim, "dprime__"))
      ensor.exp2__c <- ensor.exp2.data %>%
        select(id, c__grey.word, c__col.word, c__grey.drawing, c__col.drawing) %>%
        gather(key = "stim", value = "c", c__grey.word, c__col.word, c__grey.drawing, c__col.drawing) %>%
        mutate(stim = str_remove(stim, "c__"))
      ...
      ensor.exp2__prop.FA <- ensor.exp2.data %>%
        ...
        gather(key = "stim", value = "prop.FA", prop.FA__grey.word, prop.FA__col.word, prop.FA__grey.drawing,
               prop.FA__col.drawing) %>%
        mutate(stim = str_remove(stim, "prop.FA__"))
      ensor.exp2__recog <- ensor.exp2.data %>%
        select(id, recog__grey.word, recog__col.word, recog__grey.drawing, recog__col.drawing) %>%
        gather(key = "stim", value = "recog", recog__grey.word, recog__col.word, recog__grey.drawing,
               recog__col.drawing) %>%
        mutate(stim = str_remove(stim, "recog__"))
...
#### Manipulation check
To establish whether the distinctive word stimuli were indeed more distinctive than the regular words, a series of one-way analysis of variance (ANOVA) with six factors (grey & distinctive words, grey & colour drawings, grey & colour photographs) were run on *d'* and *c* scores, the mean proportion of hits and FAs, and overall scores of recognition (hits - FAs). Raw data provided by @ensor2019b was re-analysed to allow for direct comparisons with data from the current study.
...
##    One-way repeated measures ANOVA:
      exp5__d.prime.aov <- exp5__d.prime %>% afex::aov_4(d.prime ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Run contrasts:                                    
      exp5__d.prime.contrasts <- contrast(exp5__d.prime.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__d.prime.aov__apa <- papaja:::apa_print.afex_aov(exp5__d.prime.aov)
      exp5__d.prime.aov__main.effect <- exp5__d.prime.aov__apa$full
      exp5__d.prime.means__apa <- papaja:::apa_print.emmGrid(exp5__d.prime.means) 
      exp5__d.prime.means__grey.word <- exp5__d.prime.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__d.prime.means__col.word <- exp5__d.prime.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__d.prime.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__d.prime.contrasts) 
      exp5__d.prime.contrasts__grey.word.col.word <- exp5__d.prime.contrasts__apa$statistic
      
#################################################################################################################
##    Ensor Exp1 d':                                                                                           ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      ensor.exp1__d.prime.aov <- ensor.exp1__d.prime %>% afex::aov_4(d.prime ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0)
##    Run contrasts:                                    
      ensor.exp1__d.prime.contrasts <- contrast(ensor.exp1__d.prime.means, method = 
                                                list("grey.word - col.word" = grey.word - col.word), 
                                                adjust = "bonf")
##    Format results for use in report:
      ensor.exp1__d.prime.aov__apa <- papaja:::apa_print.afex_aov(ensor.exp1__d.prime.aov)
      ensor.exp1__d.prime.aov__main.effect <- ensor.exp1__d.prime.aov__apa$full
      ensor.exp1__d.prime.means__apa <- papaja:::apa_print.emmGrid(ensor.exp1__d.prime.means) 
      ensor.exp1__d.prime.means__grey.word <- ensor.exp1__d.prime.means__apa$estimate$greyword %>%
          str_remove("\\,.*")
      ensor.exp1__d.prime.means__col.word <- ensor.exp1__d.prime.means__apa$estimate$colword %>%
          str_remove("\\,.*")
      ensor.exp1__d.prime.contrasts__apa <- papaja:::apa_print.emmGrid(ensor.exp1__d.prime.contrasts) 
      ensor.exp1__d.prime.contrasts__grey.word.col.word <- ensor.exp1__d.prime.contrasts__apa$statistic
      
#################################################################################################################
##    Ensor Exp2 d':                                                                                           ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      ensor.exp2__d.prime.aov <- ensor.exp2__d.prime %>% afex::aov_4(d.prime ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0)
##    Run contrasts:                                    
      ensor.exp2__d.prime.contrasts <- contrast(ensor.exp2__d.prime.means, method = 
                                                list("grey.word - col.word" = grey.word - col.word), 
                                                adjust = "bonf")
##    Format results for use in report:
      ensor.exp2__d.prime.aov__apa <- papaja:::apa_print.afex_aov(ensor.exp2__d.prime.aov)
      ensor.exp2__d.prime.aov__main.effect <- ensor.exp2__d.prime.aov__apa$full
      ensor.exp2__d.prime.means__apa <- papaja:::apa_print.emmGrid(ensor.exp2__d.prime.means) 
      ensor.exp2__d.prime.means__grey.word <- ensor.exp2__d.prime.means__apa$estimate$greyword %>%
          str_remove("\\,.*")
      ensor.exp2__d.prime.means__col.word <- ensor.exp2__d.prime.means__apa$estimate$colword %>%
          str_remove("\\,.*")
      ensor.exp2__d.prime.contrasts__apa <- papaja:::apa_print.emmGrid(ensor.exp2__d.prime.contrasts) 
      ensor.exp2__d.prime.contrasts__grey.word.col.word <- ensor.exp2__d.prime.contrasts__apa$statistic
      
##    Ensor vs. current d' table: 
      exp5__table__ensor.vs.current__d.prime <- 
            tribble(~" ", ~"Grey words", ~"Distinctive words", ~"Planned comparisons",
                  "Trials: 40 study / 80 test:",
                      round(mean(ensor.exp1.data$dprime__grey.word),2),
                      round(mean(ensor.exp1.data$dprime__col.word),2),
                      ensor.exp1__d.prime.contrasts__grey.word.col.word$greyword_colword,
                  "Trials: 80 study / 160 test:",
                      round(mean(ensor.exp2.data$dprime__grey.word),2),
                      round(mean(ensor.exp2.data$dprime__col.word),2),
                      ensor.exp2__d.prime.contrasts__grey.word.col.word$greyword_colword,
                  "Trials: 60 study / 120 test:", 
                      ...
                      exp5__d.prime.contrasts__grey.word.col.word$greyword_colword)
```
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__c.aov <- exp5__c %>% afex::aov_4(c ~ 1 + (stim|id), data = .)
##    Get means: 
      exp5__c.means <- emmeans(exp5__c.aov, ~stim)
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      grey.word = c(1, 0, 0, 0, 0, 0)
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__c.contrasts <- contrast(exp5__c.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__c.aov__apa <- papaja:::apa_print.afex_aov(exp5__c.aov)
      exp5__c.aov__main.effect <- exp5__c.aov__apa$full
      exp5__c.means__apa <- papaja:::apa_print.emmGrid(exp5__c.means) 
      exp5__c.means__grey.word <- exp5__c.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__c.means__col.word <- exp5__c.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__c.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__c.contrasts) 
      exp5__c.contrasts__grey.word.col.word <- exp5__c.contrasts__apa$statistic
...
\newpage
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__c", caption = "*d'* scores for regular and distinctive word stimuli, across the current experiment and @ensor2019b. Within-subjects contrasts are presented following significant main effects of stimuli format (reported in text).", display = FALSE)
```
In the current study, mean *c* scores showed a significant main effect of stimuli format [`r exp5__c.aov__main.effect`]. Distinctive words (`r exp5__c.means__col.word`) showed significantly higher c-scores (and thus a more conservative response bias) than regular words (`r exp5__c.means__grey.word`), `r exp5__c.contrasts__grey.word.col.word`. The same was not apparent in either of the @ensor2019b experiments; while the first experiment did show a significant main effect of stimuli format [`r ensor.exp1__c.aov__main.effect`], there was no significant difference in *c* scores between distinctive and regular words. The second experiment showed no main effect of stimuli format [`r ensor.exp2__c.aov__main.effect`].
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.hit.aov <- exp5__prop.hit %>% afex::aov_4(prop.hit ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.hit.contrasts <- contrast(exp5__prop.hit.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.hit.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.hit.aov)
      exp5__prop.hit.aov__main.effect <- exp5__prop.hit.aov__apa$full
      exp5__prop.hit.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.means) 
      exp5__prop.hit.means__grey.word <- exp5__prop.hit.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.hit.means__col.word <- exp5__prop.hit.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.hit.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.contrasts) 
      exp5__prop.hit.contrasts__grey.word.col.word <- exp5__prop.hit.contrasts__apa$statistic

#################################################################################################################
##    Ensor Exp1 Prop hits:                                                                                    ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      ensor.exp1__prop.hit.aov <- ensor.exp1__prop.hit %>% afex::aov_4(prop.hit ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0)
##    Run contrasts:                                    
      ensor.exp1__prop.hit.contrasts <- contrast(ensor.exp1__prop.hit.means, method = 
                                                list("grey.word - col.word" = grey.word - col.word), 
                                                adjust = "bonf")
##    Format results for use in report:
      ensor.exp1__prop.hit.aov__apa <- papaja:::apa_print.afex_aov(ensor.exp1__prop.hit.aov)
      ensor.exp1__prop.hit.aov__main.effect <- ensor.exp1__prop.hit.aov__apa$full
      ensor.exp1__prop.hit.means__apa <- papaja:::apa_print.emmGrid(ensor.exp1__prop.hit.means) 
      ensor.exp1__prop.hit.means__grey.word <- ensor.exp1__prop.hit.means__apa$estimate$greyword %>% 
          str_remove("\\,.*")
      ensor.exp1__prop.hit.means__col.word <- ensor.exp1__prop.hit.means__apa$estimate$colword %>% 
          str_remove("\\,.*")
      ensor.exp1__prop.hit.contrasts__apa <- papaja:::apa_print.emmGrid(ensor.exp1__prop.hit.contrasts) 
      ensor.exp1__prop.hit.contrasts__grey.word.col.word <- ensor.exp1__prop.hit.contrasts__apa$statistic
      
#################################################################################################################
##    Ensor Exp2 Prop hits:                                                                                    ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      ensor.exp2__prop.hit.aov <- ensor.exp2__prop.hit %>% afex::aov_4(prop.hit ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0)
##    Run contrasts:                                    
      ensor.exp2__prop.hit.contrasts <- contrast(ensor.exp2__prop.hit.means, method = 
                                                list("grey.word - col.word" = grey.word - col.word), 
                                                adjust = "bonf")
##    Format results for use in report:
      ensor.exp2__prop.hit.aov__apa <- papaja:::apa_print.afex_aov(ensor.exp2__prop.hit.aov)
      ensor.exp2__prop.hit.aov__main.effect <- ensor.exp2__prop.hit.aov__apa$full
      ensor.exp2__prop.hit.means__apa <- papaja:::apa_print.emmGrid(ensor.exp2__prop.hit.means) 
      ensor.exp2__prop.hit.means__grey.word <- ensor.exp2__prop.hit.means__apa$estimate$greyword %>% 
          str_remove("\\,.*")
      ensor.exp2__prop.hit.means__col.word <- ensor.exp2__prop.hit.means__apa$estimate$colword %>% 
          str_remove("\\,.*")
      ensor.exp2__prop.hit.contrasts__apa <- papaja:::apa_print.emmGrid(ensor.exp2__prop.hit.contrasts) 
      ensor.exp2__prop.hit.contrasts__grey.word.col.word <- ensor.exp2__prop.hit.contrasts__apa$statistic
      ...
      exp5__table__ensor.vs.current__hits <- 
            tribble(~" ", ~"Grey words", ~"Distinctive words", ~"Planned comparisons",
                  "Trials: 40 study / 80 test:",
                      ...
                      ensor.exp1__prop.hit.contrasts__grey.word.col.word$greyword_colword,
                  "Trials: 80 study / 160 test:",
                      round(mean(ensor.exp2.data$prop.hit__grey.word),2),
                      round(mean(ensor.exp2.data$prop.hit__col.word),2),
                      ensor.exp2__prop.hit.contrasts__grey.word.col.word$greyword_colword,
                  "Trials: 60 study / 120 test:", 
                      ...
                      exp5__prop.hit.contrasts__grey.word.col.word$greyword_colword)
```

```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__hits", caption = "Mean proportion of hits for regular and distinctive word stimuli, across the current experiment and @ensor2019b. Within-subjects contrasts are presented following significant main effects of stimuli format (reported in text).", display = FALSE)
```
The ANOVA on the mean proportion of overall hits revealed a significant main effect of stimuli format, `r exp5__prop.hit.aov__main.effect`, though planned comparisons showed there was no difference in the number or hits between regular (`r exp5__prop.hit.means__grey.word`) and distinctive words (`r exp5__prop.hit.means__col.word`), `r exp5__prop.hit.contrasts__grey.word.col.word`. This was in contrast to the findings of @ensor2019b; reanalysis of their data also showed significant main effects of stimuli format across both experiments (Experiment 1: `r ensor.exp1__prop.hit.aov__main.effect`; Experiment 2: `r ensor.exp2__prop.hit.aov__main.effect`), however, distinctive words produced significantly more hits than regular words across both experiments (see `r table_numbering("exp5__table__ensor.vs.current__hits", display = "cite")`). Visual inspection of the data does not indicate the number of trials had an impact on results; while @ensor2019b observed a reduction in the proportion of hits for both word formats when trial numbers were increased, the current study still showed a lower proportion of hits than both of the @ensor2019b experiments (including the experiment with more trials). 
      ...
      exp5__table__ensor.vs.current__FAs <- 
            tribble(~" ", ~"Grey words", ~"Distinctive words", ~"Planned comparisons",
                  ...
                  "Trials: 80 study / 160 test:",
                      ...
                      ensor.exp2__prop.FA.contrasts__grey.word.col.word$greyword_colword,
                  "Trials: 60 study / 120 test:", 
                      ...
                      exp5__prop.FA.contrasts__grey.word.col.word$greyword_colword)
```

```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__FAs", caption = "Mean proportion of FAs for regular and distinctive word stimuli, across the current experiment and @ensor2019b. Within-subjects contrasts are presented following significant main effects of stimuli format (reported in text).", display = FALSE)
```

A distinctiveness effect was observed in the ANOVA on the mean proportion of FAs; a significant main effect of stimuli format [`r exp5__prop.FA.aov__main.effect`] showed that the distinctive words (`r exp5__prop.FA.means__col.word`) produced significantly fewer FAs than regular words (`r exp5__prop.FA.means__grey.word`), `r exp5__prop.FA.contrasts__grey.word.col.word`. Such a finding shows that subjects were better able to correctly reject lure items when they were presented in a distinctive format, rather than regular format, highlighting some performance benefits as a result of the manipulation. This was also somewhat supported by @ensor2019b data. In their second experiment (where trial numbers were increased), there was an identical pattern to the current study: a significant main effect of stimuli format [`r ensor.exp2__prop.FA.aov__main.effect`] showed that distinctive words produced significantly fewer FAs than regular words (see `r table_numbering("exp5__table__ensor.vs.current__FAs", display = "cite")`). The same pattern was not evident in their first experiment, however, where no significant main effect of stimuli format was found [`r ensor.exp1__prop.FA.aov__main.effect`]. Visual inspection of the data shows that subjects made more FAs in the @ensor2019b experiments compared to the current study; this is especially apparent when comparisons are made toward the experiment with more trials. While it may not be immediately clear why more FAs were made in the @ensor2019b experiments compared to the current study, examination of the FA results in conjunction with the mean proportion of hits suggests a difference in response bias may be responsible. While a higher proportion of hits was observed in the @ensor2019b studies, likewise a higher proportion of FAs was also observed. Taken together, such findings indicate the subjects in the current study were more conservative in their response patterns, and were less likely to respond *Old* in times of uncertainty than the samples of @ensor2019b. 
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__recog.aov <- exp5__recog %>% afex::aov_4(recog ~ 1 + (stim|id), data = .)
##    Get means: 
      exp5__recog.means <- emmeans(exp5__recog.aov, ~stim)
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      grey.word = c(1, 0, 0, 0, 0, 0)
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__recog.contrasts <- contrast(exp5__recog.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__recog.aov__apa <- papaja:::apa_print.afex_aov(exp5__recog.aov)
      exp5__recog.aov__main.effect <- exp5__recog.aov__apa$full
      exp5__recog.means__apa <- papaja:::apa_print.emmGrid(exp5__recog.means) 
      exp5__recog.means__grey.word <- exp5__recog.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__recog.means__col.word <- exp5__recog.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__recog.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__recog.contrasts) 
      exp5__recog.contrasts__grey.word.col.word <- exp5__recog.contrasts__apa$statistic
```

In the ANOVA on overall scores of recognition, there was a significant main effect of stim format `r exp5__recog.aov__main.effect`. The distinctive words (`r exp5__recog.means__col.word`) produced significantly better overall recognition than regular words (`r exp5__recog.means__grey.word`), `r exp5__recog.contrasts__grey.word.col.word`.
...
##    Ensor vs. current hits table: 
      exp5__table__ensor.vs.current__hits2 <- 
            tribble(~" ", ~"Distinctive words", ~"Grey drawings", ~"Planned comparisons",
                  ...
                  "Trials: 60 study / 120 test:", 
                      round(exp5__prop.hit %>% filter(stim == "col.word") %>% pull(prop.hit) %>% mean(),2),
                      round(exp5__prop.hit %>% filter(stim == "prop.hit__grey.drawing") %>% pull(prop.hit) %>%
                              mean(),2),
                      exp5__prop.hit.contrasts__col.word.grey.drawing$colword_greydrawing)
```

```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__hits2", caption = "Mean proportion of FAs for regular and distinctive word stimuli, across the current experiment and @ensor2019b. Within-subjects contrasts are presented following significant main effects of stimuli format (reported in text).", display = FALSE)
```

For the mean proportion of hits, further planned contrasts showed an intact PSE; grey drawings (`r ensor.exp2__prop.hit.means__grey.drawing`) showed a significantly higher proportion of hits than distinctive words (`r exp5__prop.hit.means__col.word`), `r ensor.exp2__prop.hit.contrasts__col.word.grey.drawing`. This was in contrast to the findings of @ensor2019b, whereby the PSE was eliminated when comparing distinctive words (Experiment 1 `r ensor.exp1__prop.hit.means__col.word`, Experiment 2 `r ensor.exp2__prop.hit.means__col.word`) to grey drawings (Experiment 1 `r ensor.exp1__prop.hit.means__grey.drawing`, Experiment 2 `r ensor.exp2__prop.hit.means__grey.drawing`).
...
```{r, echo=FALSE, results = FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.show='hide'}
#################################################################################################################
##    Proportion of R hits:                                                                                    ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.hit.R.aov <- exp5__prop.hit.R %>% afex::aov_4(prop.hit.R ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.hit.R.contrasts <- contrast(exp5__prop.hit.R.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.hit.R.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.hit.R.aov)
      exp5__prop.hit.R.aov__main.effect <- exp5__prop.hit.R.aov__apa$full
      exp5__prop.hit.R.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.R.means) 
      exp5__prop.hit.R.means__grey.word <- exp5__prop.hit.R.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.hit.R.means__col.word <- exp5__prop.hit.R.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.hit.R.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.R.contrasts) 
      exp5__prop.hit.R.contrasts__grey.word.col.word <- exp5__prop.hit.R.contrasts__apa$statistic
```

In the ANOVA on the proportion of R hits, there was a significant main effect of stim format `r exp5__prop.hit.R.aov__main.effect`. The distinctive words (`r exp5__prop.hit.R.means__col.word`) produced significantly more R hits than regular words (`r exp5__prop.hit.R.means__grey.word`), `r exp5__prop.hit.R.contrasts__grey.word.col.word`.

```{r, echo=FALSE, results = FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.show='hide'}
#################################################################################################################
##    Proportion of F hits:                                                                                    ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.hit.F.aov <- exp5__prop.hit.F %>% afex::aov_4(prop.hit.F ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.hit.F.contrasts <- contrast(exp5__prop.hit.F.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.hit.F.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.hit.F.aov)
      exp5__prop.hit.F.aov__main.effect <- exp5__prop.hit.F.aov__apa$full
      exp5__prop.hit.F.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.F.means) 
      exp5__prop.hit.F.means__grey.word <- exp5__prop.hit.F.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.hit.F.means__col.word <- exp5__prop.hit.F.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.hit.F.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.F.contrasts) 
      exp5__prop.hit.F.contrasts__grey.word.col.word <- exp5__prop.hit.F.contrasts__apa$statistic
```

In the ANOVA on the proportion of F hits, there was a significant main effect of stim format `r exp5__prop.hit.F.aov__main.effect`. The distinctive words (`r exp5__prop.hit.F.means__col.word`) produced significantly fewer F hits than regular words (`r exp5__prop.hit.F.means__grey.word`), `r exp5__prop.hit.F.contrasts__grey.word.col.word`.

```{r, echo=FALSE, results = FALSE, message=FALSE, warning=FALSE, cache=TRUE, fig.show='hide'}
#################################################################################################################
##    Proportion of G hits:                                                                                    ##
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.hit.G.aov <- exp5__prop.hit.G %>% afex::aov_4(prop.hit.G ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.hit.G.contrasts <- contrast(exp5__prop.hit.G.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.hit.G.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.hit.G.aov)
      exp5__prop.hit.G.aov__main.effect <- exp5__prop.hit.G.aov__apa$full
      exp5__prop.hit.G.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.G.means) 
      exp5__prop.hit.G.means__grey.word <- exp5__prop.hit.G.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.hit.G.means__col.word <- exp5__prop.hit.G.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.hit.G.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.hit.G.contrasts) 
      exp5__prop.hit.G.contrasts__grey.word.col.word <- exp5__prop.hit.G.contrasts__apa$statistic
```

In the ANOVA on the proportion of G hits, there was a significant main effect of stim format `r exp5__prop.hit.G.aov__main.effect`. The distinctive words (`r exp5__prop.hit.G.means__col.word`) produced significantly fewer G hits than regular words (`r exp5__prop.hit.G.means__grey.word`), `r exp5__prop.hit.G.contrasts__grey.word.col.word`.
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.FA.R.aov <- exp5__prop.FA.R %>% afex::aov_4(prop.FA.R ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.FA.R.contrasts <- contrast(exp5__prop.FA.R.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.FA.R.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.FA.R.aov)
      exp5__prop.FA.R.aov__main.effect <- exp5__prop.FA.R.aov__apa$full
      exp5__prop.FA.R.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.FA.R.means) 
      exp5__prop.FA.R.means__grey.word <- exp5__prop.FA.R.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.FA.R.means__col.word <- exp5__prop.FA.R.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.FA.R.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.FA.R.contrasts) 
      exp5__prop.FA.R.contrasts__grey.word.col.word <- exp5__prop.FA.R.contrasts__apa$statistic
```

In the ANOVA on the proportion of R FAs, there was a significant main effect of stim format `r exp5__prop.FA.R.aov__main.effect`. The distinctive words (`r exp5__prop.FA.R.means__col.word`) produced significantly fewer R FAs than regular words (`r exp5__prop.FA.R.means__grey.word`), `r exp5__prop.FA.R.contrasts__grey.word.col.word`.
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.FA.F.aov <- exp5__prop.FA.F %>% afex::aov_4(prop.FA.F ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.FA.F.contrasts <- contrast(exp5__prop.FA.F.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.FA.F.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.FA.F.aov)
      exp5__prop.FA.F.aov__main.effect <- exp5__prop.FA.F.aov__apa$full
      exp5__prop.FA.F.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.FA.F.means) 
      exp5__prop.FA.F.means__grey.word <- exp5__prop.FA.F.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.FA.F.means__col.word <- exp5__prop.FA.F.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.FA.F.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.FA.F.contrasts) 
      exp5__prop.FA.F.contrasts__grey.word.col.word <- exp5__prop.FA.F.contrasts__apa$statistic
```

In the ANOVA on the proportion of F FAs, there was a significant main effect of stim format `r exp5__prop.FA.F.aov__main.effect`. The distinctive words (`r exp5__prop.FA.F.means__col.word`) produced significantly fewer F FAs than regular words (`r exp5__prop.FA.F.means__grey.word`), `r exp5__prop.FA.F.contrasts__grey.word.col.word`.
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__prop.FA.G.aov <- exp5__prop.FA.G %>% afex::aov_4(prop.FA.G ~ 1 + (stim|id), data = .)
##    Get means: 
...
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      ...
      col.word = c(0, 1, 0, 0, 0, 0)
##    Run contrasts:                                    
      exp5__prop.FA.G.contrasts <- contrast(exp5__prop.FA.G.means, method = 
                                            list("grey.word - col.word" = grey.word - col.word), adjust = "bonf")
##    Format results for use in report:
      exp5__prop.FA.G.aov__apa <- papaja:::apa_print.afex_aov(exp5__prop.FA.G.aov)
      exp5__prop.FA.G.aov__main.effect <- exp5__prop.FA.G.aov__apa$full
      exp5__prop.FA.G.means__apa <- papaja:::apa_print.emmGrid(exp5__prop.FA.G.means) 
      exp5__prop.FA.G.means__grey.word <- exp5__prop.FA.G.means__apa$estimate$greyword %>% str_remove("\\,.*")
      exp5__prop.FA.G.means__col.word <- exp5__prop.FA.G.means__apa$estimate$colword %>% str_remove("\\,.*")
      exp5__prop.FA.G.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__prop.FA.G.contrasts) 
      exp5__prop.FA.G.contrasts__grey.word.col.word <- exp5__prop.FA.G.contrasts__apa$statistic
```

In the ANOVA on the proportion of G FAs, there was a significant main effect of stim format `r exp5__prop.FA.G.aov__main.effect` - however, the number of G FAs for distinctive words (`r exp5__prop.FA.G.means__col.word`) was not significantly different than regular words (`r exp5__prop.FA.G.means__grey.word`), `r exp5__prop.FA.G.contrasts__grey.word.col.word`.
...
In the ANOVA on d' scores, there was a significant main effect of stim format `r ensor.exp1__d.prime.aov__main.effect`. Distinctive words (`r ensor.exp1__d.prime.means__col.word`) produced significantly better discrimination between hits and FAs than regular words (`r ensor.exp1__d.prime.means__grey.word`), `r ensor.exp1__d.prime.contrasts__grey.word.col.word`.
...
#################################################################################################################
##    One-way repeated measures ANOVA:
      ensor.exp1__recog.aov <- ensor.exp1__recog %>% afex::aov_4(recog ~ 1 + (stim|id), data = .)
##    Get means: 
      ensor.exp1__recog.means <- emmeans(ensor.exp1__recog.aov, ~stim)
##    Create list of desired contrasts from the above reference grid (1 = row of interest, 0 = ignore): 
      grey.word = c(1, 0, 0, 0)
      col.word = c(0, 1, 0, 0)
##    Run contrasts:                                    
      ensor.exp1__recog.contrasts <- contrast(ensor.exp1__recog.means, method = 
                                                list("grey.word - col.word" = grey.word - col.word), 
                                                adjust = "bonf")
##    Format results for use in report:
      ensor.exp1__recog.aov__apa <- papaja:::apa_print.afex_aov(ensor.exp1__recog.aov)
      ensor.exp1__recog.aov__main.effect <- ensor.exp1__recog.aov__apa$full
      ensor.exp1__recog.means__apa <- papaja:::apa_print.emmGrid(ensor.exp1__recog.means) 
      ensor.exp1__recog.means__grey.word <- ensor.exp1__recog.means__apa$estimate$greyword %>%
          str_remove("\\,.*")
      ensor.exp1__recog.means__col.word <- ensor.exp1__recog.means__apa$estimate$colword %>% str_remove("\\,.*")
      ensor.exp1__recog.contrasts__apa <- papaja:::apa_print.emmGrid(ensor.exp1__recog.contrasts) 
      ensor.exp1__recog.contrasts__grey.word.col.word <- ensor.exp1__recog.contrasts__apa$statistic
```

In the ANOVA on overall recognition scores, there was a significant main effect of stim format `r ensor.exp1__recog.aov__main.effect`. Distinctive words (`r ensor.exp1__recog.means__col.word`) produced significantly more hits than regular words (`r ensor.exp1__recog.means__grey.word`), `r ensor.exp1__recog.contrasts__grey.word.col.word`.
