...
##    Format results for use in report:
      ...
      exp5__d.prime.means__grey.drawing <- exp5__d.prime.means__apa$estimate$greydrawing %>% str_remove("\\,.*")
      exp5__d.prime.means__col.drawing <- exp5__d.prime.means__apa$estimate$coldrawing %>% str_remove("\\,.*")
      exp5__d.prime.means__grey.photo <- exp5__d.prime.means__apa$estimate$greyphoto %>% str_remove("\\,.*")
      exp5__d.prime.means__col.photo <- exp5__d.prime.means__apa$estimate$colphoto %>% str_remove("\\,.*")
      exp5__d.prime.contrasts__apa <- papaja:::apa_print.emmGrid(exp5__d.prime.contrasts) 
      exp5__d.prime.contrasts__grey.word.col.word <- exp5__d.prime.contrasts__apa$full
      
      
      
      
# Pairwise:
means <- emmeans(exp5__aov.d.prime, ~ stim)



exp5__aov.d.prime__pairwise <- exp5__d.prime %>%
  filter(stim == "grey.word" | stim == "col.word")
exp5__anova.d_prime__q1.pairwise <- pairwise.t.test(exp5__aov.d.prime__pairwise$d.prime, 
                                                    exp5__aov.d.prime__pairwise$stim, pool.sd = FALSE)
