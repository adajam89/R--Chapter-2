...
##  Headers and footers:
    - \usepackage{fancyhdr}   
    - \pagestyle{fancy}                       ##  Template (sets Header 1 top right, H2 left + line + page numbers)
...
\newpage
# Chapter 1
Some example of some normal text. Some example of some normal text. Some example of some normal text. Some example of some normal text. Some example of some normal text. Some example of some normal text. Some example of some normal text. Some example of some normal text.
...
```{r fig.width=7, fig.height=5.5, echo=FALSE, cache=FALSE}
exp3__prop.hit.RFG__figure
```
...
##  Create figure:
    exp3__prop.FA.RFG__figure <-
        ...
        theme(
            ...
            plot.margin = margin(20, 20, 24, 30))    
```
```{r exp3__prop-rec-fam-guess-FAs--figurecaption, echo=FALSE, results = FALSE, cache=FALSE}
...
```{r, fig.height=8.2, echo=FALSE, warning = FALSE, message=FALSE, cache=FALSE}
...
```{r, echo=FALSE, results = FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.show='hide'}
##################################################################################################################
