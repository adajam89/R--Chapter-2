...
##################################################################################################################
    exp3__resp.option__main.effects__table <- tribble(
        ~"Variable means", ~"ANOVA result", "Signif",
        "Hits",
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
table_numbering(name = "exp3__resp.option__main.effects__table", caption = "Main effects of response option condition across all variables of interest.")
```
