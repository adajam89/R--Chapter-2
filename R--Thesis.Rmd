...
A key finding in @ensor2019b data was an elimination of the PSE; they demonstrated no difference in the number of hits, FAs, or *d'* scores between the distinctive words and grey drawings across both experiments. Such findings suggest their manipulation was successful in increasing the distinctiveness of word stimuli. 



In the current experiment, however, these findings were not replicated; grey drawings showed superior performance in comparison to the distinctive words for the proportion of hits and mean *d'* scores. 


Again, the current experiment produced different results; interestingly though, there were significantly more FAs for the grey drawings, as opposed to the distinctive word stimuli. This is somewhat unexpected, since the rest of the findings identify the grey drawings as having increased memorability compared to the distinctive words.
...
Despite predictions that the distinctive word stimuli would produce a higher proportion of correct hits, lower proportion of false alarms (FAs), and higher overall *d'* scores compared to regular word stimuli, the results suggest the manipulation was not wholly effective. While a lower proportion of FAs and higher *d'* scores were found for the distinctive words, they did not differ from regular words in the proportion of obtained hits. Such results make it difficult to conclude whether the distinctive word stimuli used in the current experiment were indeed more distinctive than the regular words. Indeed, one would expect items of a higher distinctiveness (and thus enhanced memorability) to specifically show a higher number of hits than items of lower distinctiveness. Indeed, this was the case in both @ensor2019b experiments, whereby the distinctive words produced a significantly higher proportion of hits compared to the regular words. The current findings could be interpreted within a DCT framework, whereby *all* words are inferior to the dual-codes of pictures (and thus 'distinctive' words will not produce better performance), there is still clear support for the distinctiveness hypothesis in the current results. While standard PSEs were expected - a finding that was abundantly clear from the data, with *all* pictures (greyscale drawings; colour drawings; greyscale photographs; colour photographs) demonstrating superior performance compared to regular words (manifesting as significantly higher proportions of hits, lower proportions of FAs, and a higher mean *d'* scores) - the *photo* superiority effects (PhSEs) of previous experiments was again evident. Whether recognition performance was compared between greyscale photograph and drawing items, or colour photograph and drawing items, photographs consistently demonstrated superior performance over drawings. 




Visual inspection of the data does not suggest the number of trials had an impact on the number of hits; while @ensor2019b did observe a reduction in the proportion of hits for both word formats when trial numbers were increased, the current study (whose trial numbers sit between the two @ensor2019b experiments) still showed a lower proportion of hits than both. While obtained *d'* scores sit between the @ensor2019b experiments - in line with reducing scores as the number of trials increases - visual inspection of the data shows that subjects generally made more FAs in the @ensor2019b experiments compared to the current study; this is especially apparent when comparisons are made between the current experiment and the @ensor2019b experiment with more trials.

While the PSE was not eliminated in the current experiment. 
...
A limitation of the current study lies in its' inability to determine how a number of factors separately contribute toward an overall level of distinctiveness. Such a 

@ensor2019b designed distinctive word stimuli that contained manipulations to colour, font, size, and capitalisation, however, there was little rationale for why these particular factors were selected. 

Such comparisons are outside the scope of the current programme of research, where innumerable combinations of such factors would need to be compared
