...
##    Final data:                                                                                               ##
##################################################################################################################
##    Merge 'exp4__participant_info' and 'exp4__test.stats' to create final tidy df:  ---------------------------- 
      exp4__participant_info <- exp3and4__participant_info %>%
          filter(col_or_grey == "col")
      exp4__final.data <- exp4__participant_info %>%
...
#   Prep key data for analysis:
#----------------------------------------------------------------------------------------------------------------
      exp4__d.prime <- exp4__colour_data %>%
