...
```{r fig.width=7, fig.height=5, echo=FALSE, cache=FALSE, warning=FALSE}
    exp5__manip.check__figure + exp5__figure__rfg.hits
```
...
```{r, fig.height=6.4, echo=FALSE, warning = FALSE, message=FALSE, cache=TRUE}
      grid.arrange(exp5__manip.check__figure, exp5__figure__rfg.hits,
                   exp3.vs.exp4__fam.hits,
                   ncol=2, nrow=2) #top = textGrob("Mean proportion of hits"))
```
