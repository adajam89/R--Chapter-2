...
All analyses were conducted using *R* [@rcoreteam2020] using the *afex* [`r str_c("v", str_remove(packages_versions("afex"), "([^\\s]+)\\s"))`; @afex] and *rstatix* packages [`r str_c("v", str_remove(packages_versions("rstatix"), "([^\\s]+)\\s"))`; @rstatix].
