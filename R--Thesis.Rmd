...
#### Manipulation check
To establish whether the distinctive word stimuli were indeed more distinctive than regular words, a series of one-way repeated measures analyses of variance (ANOVA) - using six factors (grey & distinctive words, grey & colour drawings, grey & colour photographs) - were conducted on the mean scores of *d'* and *c*, proportion of hits and FAs, and overall scores of recognition (hits - FAs). 

Mauchly's Test of Sphericity

Sphericity was assessed using Mauchly's test; when the assumption of sphericity was violated, Greenhouse-Geisser 


Raw data provided by @ensor2019b was re-analysed to allow for direct comparisons with data from the current study.

estimate of sphericity (ε)
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.hit.aov__nice <- nice(exp5__prop.hit.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.FA.aov__nice <- nice(exp5__prop.FA.aov, correction = "GG", es = "ges")
#----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
##################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__d.prime.aov <- afex::aov_ez('id', 'd.prime', fun_aggregate = mean, exp5__d.prime, within = 'stim',
                                        anova_table=list(correction = "none", es = "none"))
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__d.prime.aov__nice <- nice(exp5__d.prime.aov, correction = "GG", es = "ges")
#----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
##################################################################################################################
##    One-way repeated measures ANOVA:
      exp5__c.aov <- afex::aov_ez('id', 'c', fun_aggregate = mean, exp5__c, within = 'stim',
                                        anova_table=list(correction = "none", es = "none"))

##    Mauchlys test of sphericity:
      exp5__c.aov__sphericity <- test_sphericity(exp5__c.aov)
      exp5__c.aov__sphericity <- exp5__c.aov__sphericity[1,2]
      
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__c.aov__nice <- nice(exp5__c.aov, correction = "GG", es = "ges")
#----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
      exp5__c__ttest <- exp5__c %>% filter(stim == "grey.word" | stim == "col.word") %>%
                                      t.test(c~stim, paired=TRUE, data = .)
##    Get means:
      exp5__c.means <- emmeans(exp5__c.aov, ~stim)
      exp5__c.means__grey.word <- summary(exp5__c.means)$emmean[1] %>% round(2)
      exp5__c.means__col.word <- summary(exp5__c.means)$emmean[2] %>% round(2)      
```

The ANOVA on the mean proportion of overall hits revealed a significant main effect of stimuli format, `r apa::anova_apa(exp5__prop.hit.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. However, planned comparisons revealed there was no difference in the number of hits between distinctive (*M* = `r exp5__prop.hit.means__col.word`) and regular words (*M* = `r exp5__prop.hit.means__grey.word`), `r apa::apa(exp5__prop.hit__ttest, format = "rmarkdown", print = FALSE)`. 

The ANOVA on the mean proportion of FAs also showed a significant main effect of stimuli format, `r apa::anova_apa(exp5__prop.FA.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__prop.FA.means__col.word`) showed significantly fewer FAs than regular words (*M* = `r exp5__prop.FA.means__grey.word`), `r apa::apa(exp5__prop.FA__ttest, format = "rmarkdown", print = FALSE)`. 

The ANOVA on mean *d'* scores also showed a significant main effect of stimuli format, `r apa::anova_apa(exp5__d.prime.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__d.prime.means__col.word`) showed significantly higher *d'* scores than regular words (*M* = `r exp5__d.prime.means__grey.word`), `r apa::apa(exp5__d.prime__ttest, format = "rmarkdown", print = FALSE)`. 

The ANOVA on mean *c* scores also showed a significant main effect of stimuli format, `r apa::anova_apa(exp5__c.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__c.means__col.word`) showed significantly higher *c* scores than regular words (*M* = `r exp5__c.means__grey.word`), `r apa::apa(exp5__c__ttest, format = "rmarkdown", print = FALSE)`. 

#### Recollection and Familiarity 
To determine if *Recollection* and *Familiarity* response patterns were mediated by the format of word stimuli, further one-way repeated measures analyses of variance (ANOVA) were conducted on the mean proportion of hits and false alarms (FAs) assigned *Recollection*, *Familiarity*, and *Guessing*. 
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.hit.R.aov__nice <- nice(exp5__prop.hit.R.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.hit.F.aov__nice <- nice(exp5__prop.hit.F.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.hit.G.aov__nice <- nice(exp5__prop.hit.G.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
In the ANOVA on the proportion of R hits, there was a significant main effect of stimuli format `r apa::anova_apa(exp5__prop.hit.R.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__prop.hit.R.means__col.word`) produced significantly more R hits than regular words (*M* = `r exp5__prop.hit.R.means__grey.word`), `r apa::apa(exp5__prop.hit.R__ttest, format = "rmarkdown", print = FALSE)`. 

In the ANOVA on the proportion of F hits, there was a significant main effect of stimuli format `r apa::anova_apa(exp5__prop.hit.F.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__prop.hit.F.means__col.word`) produced significantly fewer F hits than regular words (*M* = `r exp5__prop.hit.F.means__grey.word`), `r apa::apa(exp5__prop.hit.F__ttest, format = "rmarkdown", print = FALSE)`. 

In the ANOVA on the proportion of G hits, there was a significant main effect of stimuli format `r apa::anova_apa(exp5__prop.hit.G.aov, effect = "stim", format = "rmarkdown", print = FALSE)`, however, the planned contrast did not show a significant difference in the number of hits assigned *Guessing* between distinctive words (*M* = `r exp5__prop.hit.G.means__col.word`) and regular words (*M* = `r exp5__prop.hit.G.means__grey.word`), `r apa::apa(exp5__prop.hit.G__ttest, format = "rmarkdown", print = FALSE)`.
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.FA.R.aov__nice <- nice(exp5__prop.FA.R.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.FA.F.aov__nice <- nice(exp5__prop.FA.F.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
##    Assumption of sphericity violated (p<.05), so apply Greenhouse-Geisser correction:
      exp5__prop.FA.G.aov__nice <- nice(exp5__prop.FA.G.aov, correction = "GG", es = "ges")
#-----------------------------------------------------------------------------------------------------------------
##    Significant main effect, so perform Paired Samples t-test:
...
In the ANOVA on the proportion of R FAs, there was a significant main effect of stimuli format `r apa::anova_apa(exp5__prop.FA.R.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__prop.FA.R.means__col.word`) produced significantly fewer R FAs than regular words (*M* = `r exp5__prop.FA.R.means__grey.word`), `r apa::apa(exp5__prop.FA.R__ttest, format = "rmarkdown", print = FALSE)`. 

In the ANOVA on the proportion of F FAs, there was a significant main effect of stimuli format `r apa::anova_apa(exp5__prop.FA.F.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. The distinctive words (*M* = `r exp5__prop.FA.F.means__col.word`) produced significantly fewer F FAs than regular words (*M* = `r exp5__prop.FA.F.means__grey.word`), `r apa::apa(exp5__prop.FA.F__ttest, format = "rmarkdown", print = FALSE)`. 

In the ANOVA on the proportion of G FAs, there was a significant main effect of stimuli format `r apa::anova_apa(exp5__prop.FA.G.aov, effect = "stim", format = "rmarkdown", print = FALSE)`. However, the follow up contrasts showed no difference in the number of FAs assigned *Guessing* between distinctive (*M* = `r exp5__prop.FA.G.means__col.word`) and regular words (*M* = `r exp5__prop.FA.G.means__grey.word`), `r apa::apa(exp5__prop.FA.G__ttest, format = "rmarkdown", print = FALSE)`.
