...
Such findings cannot readily be accounted for by dual-coding accounts of the PSE [@paivio1968], where one would expect both drawings and photographs to similarly generate imagined and verbal representations of the stimulus (and thus their superiority over words should be the same, with no additional advantage for photographs). The PhSE demonstrated in the previous experiments is best understood within a distinctiveness framework [@mintzer1999]; increased item-to-item variability between the detailed photograph items acted to enhance their memorability in comparison to line drawings, where this item-to-item variability was less apparent. 

The current study aims to 



A secondary aim is to further characterise the role of colour in the previously established *photo* superiority effect (PhSE). In *Experiment 3* (greyscale pictures) and *Experiment 4* (colour pictures), photographs produced clear recognition benefits over line drawings; in both studies, photograph items produced a significantly higher proportion of hits, lower proportion of FAs, and higher *d'* scores compared to drawings. Since analyses could only be performed between drawings and photographs of the same colour modality (i.e. i) drawings without vs. photographs without in *Experiment 3*; and ii) drawings with vs. photographs with in *Experiment 4*), the extent to which colour is involved in the PhSE, if at all, remains mostly unclear. In a scene recognition paradigm (utilising pictures of city streets, parks etc.), @suzuki1997 demonstrated enhanced recognition performance when colour - as opposed to greyscale - items were shown at study and test. Interestingly, this benefit was only apparent when study and test conditions congruently presented items in colour; any recognition enhancements attributed to colour disappeared when blocks were incongruent (e.g. items presented in grey at study, and the same items presented in colour at test). @suzuki1997 found that subjects' memory for the colour mode items had been presented in at study was poor; in other words, participants could not remember well whether they had studied items in colour or greyscale, despite exhibiting better recognition for colour/colour items. Since the benefits of colour information could not be attributed to any conscious recall of the actual colours in the pictures, it was instead hypothesised colour information acts to indirectly highlight certain features in a picture - i.e. details that were not otherwise noticed as prominently in greyscale - and thus increases their distinctiveness (and memorability) as a result.

It is unclear whether colour information provides similar benefits in object recognition, or if this effect  applies exclusively to real-world photographs of scenes (presumably comprised of a multitude of items). If colour enhancements are present in object recognition, however, it is possible that the PhSE could be eliminated as a result. In the same way the PSE is eliminated between words and drawings when word stimuli are made more distinctive [@ensor2019b], the PhSE may too be eliminated when comparisons are made between colour drawings (whose distinctiveness is presumably somewhat enhanced by colour) and greyscale photographs (whose real-world details and textures increase their distinctiveness in relation to drawings, but colour enhancements are absent). 




Indeed, @ensor2019b demonstrated some differential effects to suggest colour information produces some benefits in object recognition; in their first experiment, the PSE was eliminated when comparisons were made between colour words and greyscale drawings (suggesting similar levels of distinctiveness between the two formats), but the PSE was only attenuated when comparisons were made with colour drawings (suggesting the colour drawings were more distinct than the greyscale drawings). However, this difference was no longer evident when the number of study and test trials were doubled (the PSE was eliminated for greyscale *and* colour drawings), indicating any distinctiveness benefits of colour might be susceptible to particular methodological circumstances. This notion is supported by @paivio1968, whereby the PSE was examined in relation to 

Visual inspection of the results from *Experiment 3* and *Experiment 4* of the current programme of research suggest an elimination of the PhSE to be unlikely; comparisons show colour information had a negligible impact on recognition, with both experiments displaying highly similar PSE and PhSE magnitudes, proportions of hits, FAs, and mean *d'* scores, and patterns of RFG responding. Object recognition does not appear to benefit from the additive effects of colour information that render items more distinctive to the same extent as scene recognition [@suzuki1997], if at all. Regardless, the current study allows for the statistical comparison of greyscale and colour stimuli in order to further test this hypothesis. 
