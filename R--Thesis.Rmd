...
##    Stimuli format:
      ...
      exp4__anova_prop_FA_drawing_photo_emmeans <- exp4__anova_prop_FA_stim_format_mmeans[2:3]
...
##    Stimuli format:
      ...
      exp4__anova_recog_drawing_photo_emmeans <- exp4__anova_recog_stim_format_mmeans[2:3]
...
##    Stimuli format:
      ...
      exp4__anova_d_prime_drawing_photo_emmeans <- exp4__anova_d_prime_stim_format_mmeans[2:3]
...
##    Stimuli format:
      ...
      exp4__anova_c_drawing_photo_emmeans <- exp4__anova_c_stim_format_mmeans[2:3]
...
### Response option
In each of the previously discussed ANOVAs, the role of response option was also assessed. However, there were no significant interaction effects between stimuli format and response option for: i) proportion of hits; ii) proportion of FAs; iii) overall recognition; iv) *d'*-scores; v) *c*-scores. 

for response option: RFG vs. RFBG).
