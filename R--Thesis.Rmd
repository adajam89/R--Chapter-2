...
**Q1. Are 'distinctive' words more distinctive than grey words?**

All had signif main effect of stim-format (grey words / col words / grey drawings / col drawings / grey photos / col photos).
...
**Q3. Are 'distinctive' words just as distinctive as grey drawings?**
...
1. **d-prime:**
    ...
    + ii) Different to Ensor (found no difference, i.e. PSE eliminated).
    + iii) Ensor (Distinctive words = 2.97, Grey drawings =  2.96). 
        
2. **c scores:**
    + i) ***??:*** Distinctive words (`r exp5__anova.c__means__distinctive_word`) had significantly higher c scores (responses were more conservative) than grey drawings (`r exp5__anova.c__means__grey_drawing`). 
    + ii) Ensor, same pattern as in Exp 2 (Distinctive words = –.005, Grey drawings =  .106). 
