...
##    Main effects:
      ...
      exp1__apa_anova_prop_guess_hit$full$ResponseOption_StimuliFormat <- 
          exp1__apa_anova_prop_guess_hit$full$ResponseOption_StimuliFormat
##    Pairwise (stim-format):
      exp1__apa_anova_prop_guess_hit_stim_format_mmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_hit_stim_format_mmeans)
      exp1__pics_prop_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_stim_format_mmeans$estimate$Pictures %>%
          str_remove("\\,.*")
      exp1__words_prop_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_stim_format_mmeans$estimate$Words %>%
          str_remove("\\,.*")
      ...
      exp1__pics_words_guess_hit_ttest <- exp1__apa_anova_prop_guess_hit_stim_format_pairwise$full %>%
          str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
##    Pairwise (resp-option):
      exp1__apa_anova_prop_guess_hit_resp_option_mmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_hit_resp_option_mmeans)
      exp1__rfg_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_resp_option_mmeans$estimate$RFG %>% 
          str_remove("\\,.*")
      exp1__rfbg_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_resp_option_mmeans$estimate$RFBG %>% 
          str_remove("\\,.*")
      exp1__rfr_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_resp_option_mmeans$estimate$RF_Ratings %>% 
          str_remove("\\,.*")
      ...
      exp1__rfbg_rfr_guess_hit_ttest <- 
          ...
          str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")  
##    Pairwise (interaction):
      exp1__apa_anova_prop_guess_hit_interaction_mmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_hit_interaction_mmeans)
      exp1__rfg_words_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_interaction_mmeans$estimate$RFG_Words %>% 
          str_remove("\\,.*")
      exp1__rfg_pics_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_interaction_mmeans$estimate$RFG_Pictures %>% 
          str_remove("\\,.*")
      exp1__rfbg_words_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_interaction_mmeans$estimate$RFBG_Words %>% 
          str_remove("\\,.*")
      exp1__rfbg_pics_guess_hit_mean <- 
          exp1__apa_anova_prop_guess_hit_interaction_mmeans$estimate$RFBG_Pictures %>% str_remove("\\,.*")
      exp1__rfr_words_guess_hit_mean <- 
          exp1__apa_anova_prop_guess_hit_interaction_mmeans$estimate$RF_Ratings_Words %>% str_remove("\\,.*")
      exp1__rfr_pics_guess_hit_mean <- 
          exp1__apa_anova_prop_guess_hit_interaction_mmeans$estimate$RF_Ratings_Pictures %>% str_remove("\\,.*")
...
##    Main effects:
      ...
      exp1__apa_anova_prop_rec_FA$full$ResponseOption_StimuliFormat <- 
          exp1__apa_anova_prop_rec_FA$full$ResponseOption_StimuliFormat
##    Pairwise (resp-option):
      exp1__apa_anova_prop_rec_FA_resp_option_mmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_rec_FA_resp_option_mmeans)
      exp1__rfg_rec_FA_mean <- exp1__apa_anova_prop_rec_FA_resp_option_mmeans$estimate$RFG %>% str_remove("\\,.*")
      exp1__rfbg_rec_FA_mean <- exp1__apa_anova_prop_rec_FA_resp_option_mmeans$estimate$RFBG %>% 
          str_remove("\\,.*")
      exp1__rfr_rec_FA_mean <- exp1__apa_anova_prop_rec_FA_resp_option_mmeans$estimate$RF_Ratings %>% 
          str_remove("\\,.*")
...
##    Main effects:
      ...
      exp1__apa_anova_prop_guess_FA$full$ResponseOption_StimuliFormat <- 
          exp1__apa_anova_prop_guess_FA$full$ResponseOption_StimuliFormat
##    Pairwise (resp-option):
      exp1__apa_anova_prop_guess_FA_resp_option_mmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_FA_resp_option_mmeans)
      exp1__rfg_guess_FA_mean <- exp1__apa_anova_prop_guess_FA_resp_option_mmeans$estimate$RFG %>% 
          str_remove("\\,.*")
      exp1__rfbg_guess_FA_mean <- exp1__apa_anova_prop_guess_FA_resp_option_mmeans$estimate$RFBG %>% 
          str_remove("\\,.*")
      exp1__rfr_guess_FA_mean <- exp1__apa_anova_prop_guess_FA_resp_option_mmeans$estimate$RF_Ratings %>% 
          str_remove("\\,.*")
...
```{r echo=FALSE, results = FALSE, cache=TRUE}
      table_numbering(name = "exp4__hit.FA.recog.table",
                      caption = "Mean proportion of hits, FAs, and overall recognition, by stimuli format and response option condition.")
```

### Distinctiveness
To determine whether colour photographs were more distinctive than colour drawings, and examine any potential interactions with response-option condition, a series of 2 (stimuli format: words, pictures) x 3 (response option condition: RFG-judgements, RFBG-judgements, RF-ratings) mixed ANOVAs were conducted on the proportion of overall hits, false alarms (FAs), and overall recognition (hits - FAs) [see `r table_numbering("exp4__hit.FA.recog.table", display = "cite")`]. To further examine response patterns between the stimuli formats, ANOVAs were also run on the signal detection measures of *d'* (measure of sensitivity) and *c* (decision criterion). Significant main effects and interaction effects were followed-up with Bonferroni-adjusted pairwise comparisons.
...
##    Post-hoc contrasts:
##    Stimuli format:
      exp4__anova_prop_hit_stim_format_mmeans <- emmeans(exp4__anova_prop_hit, ~ stim_format)
      exp4__anova_prop_hit_stim_format_pairwise <-pairs(exp4__anova_prop_hit_stim_format_mmeans, 
                                                        adjust = "bonferroni")
##    Interaction means (for figure): 
      exp4__anova_prop_hit_interaction_mmeans <- 
...
##    Stim format pairwise:
      exp4__apa_anova_prop_hit_stim_format_mmeans <- papaja:::apa_print.emmGrid(
                                                     exp4__anova_prop_hit_stim_format_mmeans)
      exp4__drawings_prop_hit_mean <- exp4__apa_anova_prop_hit_stim_format_mmeans$estimate$Drawings %>%
                                      str_remove("\\,.*")
      exp4__photos_prop_hit_mean <- exp4__apa_anova_prop_hit_stim_format_mmeans$estimate$Photographs %>%
                                      str_remove("\\,.*")
      exp4__apa_anova_prop_hit_stim_format_pairwise <- 
          papaja:::apa_print.emmGrid(exp4__anova_prop_hit_stim_format_pairwise)
      exp4__drawings_photo_hit_ttest <-exp4__apa_anova_prop_hit_stim_format_pairwise$statistic$Drawings_Photographs
###################################################################################################################
##    Analysis - Prop FA ANOVA:                                                                                  ##
###################################################################################################################
...
##    Post-hoc contrasts:
##    Stimuli format:
      exp4__anova_prop_FA_stim_format_mmeans <- emmeans(exp4__anova_prop_FA, ~ stim_format)
      exp4__anova_prop_FA_stim_format_pairwise <-pairs(exp4__anova_prop_FA_stim_format_mmeans, 
                                                        adjust = "bonferroni")
##    Response option:
      exp4__anova_prop_FA_resp_option_mmeans <- emmeans(exp4__anova_prop_FA, ~ resp_option)
      exp4__anova_prop_FA_resp_option_pairwise <-pairs(exp4__anova_prop_FA_resp_option_mmeans, 
                                                        adjust = "bonferroni")
##    Interaction means (for figure): 
      exp4__anova_prop_FA_interaction_mmeans <- 
...
##    Stim format pairwise:
      exp4__apa_anova_prop_FA_stim_format_mmeans <- papaja:::apa_print.emmGrid(
                                                    exp4__anova_prop_FA_stim_format_mmeans)
      exp4__drawings_prop_FA_mean <- exp4__apa_anova_prop_FA_stim_format_mmeans$estimate$Drawings %>%
                                      str_remove("\\,.*")
      exp4__photos_prop_FA_mean <- exp4__apa_anova_prop_FA_stim_format_mmeans$estimate$Photographs %>%
                                      str_remove("\\,.*")
      exp4__apa_anova_prop_FA_stim_format_pairwise <- 
          papaja:::apa_print.emmGrid(exp4__anova_prop_FA_stim_format_pairwise)
      exp4__drawings_photo_FA_ttest <- exp4__apa_anova_prop_FA_stim_format_pairwise$statistic$Drawings_Photographs
##    Resp option pairwise:
      exp4__apa_anova_prop_FA_resp_option_mmeans <- 
          papaja:::apa_print.emmGrid(exp4__anova_prop_FA_resp_option_mmeans)
      exp4__RFG_prop_FA_mean <- exp4__apa_anova_prop_FA_resp_option_mmeans$estimate$RFG %>% str_remove("\\,.*")
      exp4__RFBG_prop_FA_mean <- exp4__apa_anova_prop_FA_resp_option_mmeans$estimate$RFBG %>% str_remove("\\,.*")
...
##    Post-hoc contrasts:
##    Stimuli format:
      exp4__anova_recog_stim_format_mmeans <- emmeans(exp4__anova_recog, ~ stim_format)
      exp4__anova_recog_stim_format_pairwise <-pairs(exp4__anova_recog_stim_format_mmeans, 
                                                        adjust = "bonferroni")
##    Interaction means (for figure): 
      exp4__anova_recog_interaction_mmeans <- 
...
##    Post-hoc contrasts:
##    Stimuli format:
      exp4__anova_d_prime_stim_format_mmeans <- emmeans(exp4__anova_d_prime, ~ stim_format)
      exp4__anova_d_prime_stim_format_pairwise <- pairs(exp4__anova_d_prime_stim_format_mmeans, 
                                                        adjust = "bonferroni")
##    Interaction means (for figure): 
      exp4__anova_d_prime_interaction_mmeans <- 
...
##    Stim format pairwise:
      exp4__apa_anova_d_prime_stim_format_mmeans <- papaja:::apa_print.emmGrid(
                                                     exp4__anova_d_prime_stim_format_mmeans)
      exp4__drawings_d_prime_mean <- exp4__apa_anova_d_prime_stim_format_mmeans$estimate$Drawings %>%
                                      str_remove("\\,.*")
      exp4__photos_d_prime_mean <- exp4__apa_anova_d_prime_stim_format_mmeans$estimate$Photographs %>%
                                      str_remove("\\,.*")
      exp4__apa_anova_d_prime_stim_format_pairwise <- 
          papaja:::apa_print.emmGrid(exp4__anova_d_prime_stim_format_pairwise)
      exp4__drawings_photo_d_prime_ttest <- 
          exp4__apa_anova_d_prime_stim_format_pairwise$statistic$Drawings_Photographs
#------------------------------------------------------------------------------------------------------------------
#   c:
#------------------------------------------------------------------------------------------------------------------
...
##    Post-hoc contrasts:
##    Stimuli format:
      exp4__anova_c_stim_format_mmeans <- emmeans(exp4__anova_c, ~ stim_format)
      exp4__anova_c_stim_format_pairwise <- pairs(exp4__anova_c_stim_format_mmeans, adjust = "bonferroni")
##    Stimuli format:
      exp4__anova_c_resp_option_mmeans <- emmeans(exp4__anova_c, ~ resp_option)
      exp4__anova_c_resp_option_pairwise <- pairs(exp4__anova_c_resp_option_mmeans, adjust = "bonferroni")      
##    Interaction means (for figure): 
      exp4__anova_c_interaction_mmeans <- emmeans(exp4__anova_c, ~ resp_option:stim_format)
#------------------------------------------------------------------------------------------------------------------
#   Format results for report:
#------------------------------------------------------------------------------------------------------------------
...
##    Stim format pairwise:
      exp4__apa_anova_c_stim_format_mmeans <- papaja:::apa_print.emmGrid(exp4__anova_c_stim_format_mmeans)
      exp4__drawings_c_mean <- exp4__apa_anova_c_stim_format_mmeans$estimate$Drawings %>% str_remove("\\,.*")
      exp4__photos_c_mean <- exp4__apa_anova_c_stim_format_mmeans$estimate$Photographs %>% str_remove("\\,.*")
      exp4__apa_anova_c_stim_format_pairwise <- papaja:::apa_print.emmGrid(exp4__anova_c_stim_format_pairwise)
      exp4__drawings_photo_c_ttest <- exp4__apa_anova_c_stim_format_pairwise$statistic$Drawings_Photographs      
##    Resp option pairwise:
      exp4__apa_anovac_resp_option_mmeans <- papaja:::apa_print.emmGrid(exp4__anova_c_resp_option_mmeans)
      exp4__RFG_c_mean <- exp4__apa_anovac_resp_option_mmeans$estimate$RFG %>% str_remove("\\,.*")
      exp4__RFBG_c_mean <- exp4__apa_anovac_resp_option_mmeans$estimate$RFBG %>% str_remove("\\,.*")
...
### Response option
No interaction effects were found between stimuli format and response option for: 1) proportion of hits; 2) proportion of FAs; 3) overall recognition; 4) *d'* scores; 5) *c*-scores.
