...
a <- "$\\diamond$"    
    exp3.and.4__prop.hit.FA.d.prime__table <- tribble(
        ...
        "Stimuli format:", "", "***", "***", "a", "", "Stimuli format:", "", "***", "***", "***",
        ...
        "Response option:", "", "*", "", "a", "", "Response option:", "", "", "*", "",
...
```{r, echo=FALSE, cache=FALSE}
    exp3.and.4__prop.hit.FA.d.prime__table %>%
        ...
        add_header_above(c("Experiment 3: Grey" = 5, " " = 1, "Experiment 4: Colour" = 5), line = F, bold = T) %>%
