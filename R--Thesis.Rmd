...
A second method of measurement is to ask participants to make confidence judgments
...
the memory test; here, rather than a binary Remember-Know judgment which means that the
...
method which uses judgments but permits participants to report that they have both recollection
and familiarity for an item is the Recollect-Familiar-Both judgment task.
...
2. Are ratings tasks better than judgment tasks: Recollection and familiarity or
...
‘accurate’ than more standard RK judgment tasks? I want to examine how patterns of
