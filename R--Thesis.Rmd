...
s
despite  
the inability to retrieve any associated contextual information.

Despite the popularity of this dual-process model of recognition [@paivio1971; @paivio1972], there remains a disagreement throughout the literature regarding the extent to which recollection and
familiarity are independent processes, and the methods used to measure them most effectively. 

Experimental paradigms are generally categorized into two broad groups: task-dissociation and process-estimation methods. Task-dissociation methods combine two different task formats (e.g. old/new recognition paired with forced-choice recognition), and make comparisons in an attempt to isolate either recollection or familiarity (Yonelinas, 2002). Old/new recognition tests are thought to isolate recollection; stimuli are presented individually and participants attempt to make an accurate judgement about items they previously studied (targets) when presented amongst novel items with highly similar characteristics (lures). Forced-choice recognition paradigms, on the other hand, can rely on recollection or familiarity; discrimination between previously studied targets and highly similar lures is again required, however, recognition trials present target-lure pairs at the same time and require that participants select between them.s



One of the most commonly used methods in recognition memory research is the Remember-
Know (RK) paradigm [@gardiner2000; @jacoby1991; @jacoby1997; @tulving1985]


. In the RK paradigm participants categorise an item on a recognition test as ‘Remember’ when recognition is accompanied by recollection, or as ‘Know’, when
recognition is not accompanied by recollection and instead is accompanied by a feeling of
familiarity or certainty. A ‘Guess’ option is also usually provided to try to ensure that participants
can assign any guesses they make to that category (rather than assign them to Remember or
Know). A second method of measurement is to ask participants to make confidence judgments
