...
##    Grey words:
          ...
          mutate_at(vars(prop.hit.R__grey.word, prop.hit.F__grey.word, prop.hit.G__grey.word), 
                    ~replace(., is.nan(.), 0)) %>%
##    Distinctive words:
          ...
          mutate_at(vars(prop.hit.R__col.word, prop.hit.F__col.word, prop.hit.G__col.word), 
                    ~replace(., is.nan(.), 0)) %>%
##    Grey drawings:
          ...
          mutate_at(vars(prop.hit.R__grey.drawing, prop.hit.F__grey.drawing, prop.hit.G__grey.drawing), 
                    ~replace(., is.nan(.), 0)) %>%  
##    Col drawings:
          ...
          mutate_at(vars(prop.hit.R__col.drawing, prop.hit.F__col.drawing, prop.hit.G__col.drawing), 
                    ~replace(., is.nan(.), 0)) %>%    
##    Grey photos:
          ...
          mutate_at(vars(prop.hit.R__grey.photo, prop.hit.F__grey.photo, prop.hit.G__grey.photo), 
                    ~replace(., is.nan(.), 0)) %>%      
##    Col photos:
          ...
          mutate_at(vars(prop.hit.R__col.photo, prop.hit.F__col.photo, prop.hit.G__col.photo), 
                    ~replace(., is.nan(.), 0)) %>%     
#################################################################################################################
##    Calculate FA proportions:                                                                                ##
#################################################################################################################
##    Grey words:
          ...
          mutate_at(vars(prop.FA.R__grey.word, prop.FA.F__grey.word, prop.FA.G__grey.word), 
                    ~replace(., is.nan(.), 0)) %>%
##    Distinctive words:
          ...
          mutate_at(vars(prop.FA.R__col.word, prop.FA.F__col.word, prop.FA.G__col.word), 
                    ~replace(., is.nan(.), 0)) %>%
##    Grey drawings:
          ...
          mutate_at(vars(prop.FA.R__grey.drawing, prop.FA.F__grey.drawing, prop.FA.G__grey.drawing), 
                    ~replace(., is.nan(.), 0)) %>%  
##    Col drawings:
          ...
          mutate_at(vars(prop.FA.R__col.drawing, prop.FA.F__col.drawing, prop.FA.G__col.drawing), 
                    ~replace(., is.nan(.), 0)) %>%    
##    Grey photos:
          ...
          mutate_at(vars(prop.FA.R__grey.photo, prop.FA.F__grey.photo, prop.FA.G__grey.photo), 
                    ~replace(., is.nan(.), 0)) %>%   
##    Col photos:
          ...
          mutate_at(vars(prop.FA.R__col.photo, prop.FA.F__col.photo, prop.FA.G__col.photo), 
                    ~replace(., is.nan(.), 0)) %>%     
#################################################################################################################
##    Accuracy:                                                                                                ##
#################################################################################################################
...
## Grey words:      
    ...
    ## Rec:
      exp5__grey.word.d.prime__rec <- exp5__test_stats %>%
    ...
    ## Fam:
      exp5__grey.word.d.prime__fam <- exp5__test_stats %>%
    ...
    ## Guess:
      exp5__grey.word.d.prime__guess <- exp5__test_stats %>%
...
## Colour words:      
    ...
    ## Rec:      
      exp5__col.word.d.prime__rec <- exp5__test_stats %>%
    ...
    ## Fam:
      exp5__col.word.d.prime__fam <- exp5__test_stats %>%
    ...
    ## Guess:
      exp5__col.word.d.prime__guess <- exp5__test_stats %>%
...
## Grey drawings:      
    ...
    ## Rec:      
      exp5__grey.drawing.d.prime__rec <- exp5__test_stats %>%
    ...
    ## Fam:
      exp5__grey.drawing.d.prime__fam <- exp5__test_stats %>%
    ...
    ## Guess:
      exp5__grey.drawing.d.prime__guess <- exp5__test_stats %>%
...
## Colour drawings:      
    ...
    ## Rec:      
      exp5__col.drawing.d.prime__rec <- exp5__test_stats %>%
    ...
    ## Fam:
      exp5__col.drawing.d.prime__fam <- exp5__test_stats %>%
    ...
    ## Guess:
      exp5__col.drawing.d.prime__guess <- exp5__test_stats %>%
...
## Grey photos:      
    ...
    ## Rec:      
      exp5__grey.photo.d.prime__rec <- exp5__test_stats %>%
          select(id, prop.hit.R__grey.photo, prop.FA.R__grey.photo) %>%
          mutate(prop.hit.R__grey.photo = replace(prop.hit.R__grey.photo, 
                                                    prop.hit.R__grey.photo == 1, .99)) %>%
          mutate(prop.hit.R__grey.photo = replace(prop.hit.R__grey.photo, 
                                                    prop.hit.R__grey.photo == 0, .01)) %>%
    ...
    ## Fam:
      exp5__grey.photo.d.prime__fam <- exp5__test_stats %>%
          select(id, prop.hit.F__grey.photo, prop.FA.F__grey.photo) %>%
          mutate(prop.hit.F__grey.photo = replace(prop.hit.F__grey.photo, 
                                                    prop.hit.F__grey.photo == 1, .99)) %>%
          mutate(prop.hit.F__grey.photo = replace(prop.hit.F__grey.photo, 
                                                    prop.hit.F__grey.photo == 0, .01)) %>%
    ...
    ## Guess:
      exp5__grey.photo.d.prime__guess <- exp5__test_stats %>%
          select(id, prop.hit.G__grey.photo, prop.FA.G__grey.photo) %>%
          mutate(prop.hit.G__grey.photo = replace(prop.hit.G__grey.photo, 
                                                    prop.hit.G__grey.photo == 1, .99)) %>%
          mutate(prop.hit.G__grey.photo = replace(prop.hit.G__grey.photo, 
                                                    prop.hit.G__grey.photo == 0, .01)) %>%
...
#---------------------------------------------------------------------------------------------------------------- ## Colour photos:      
    ...
    ## Rec:      
      exp5__col.photo.d.prime__rec <- exp5__test_stats %>%
          select(id, prop.hit.R__col.photo, prop.FA.R__col.photo) %>%
          mutate(prop.hit.R__col.photo = replace(prop.hit.R__col.photo, 
                                                    prop.hit.R__col.photo == 1, .99)) %>%
          mutate(prop.hit.R__col.photo = replace(prop.hit.R__col.photo, 
                                                    prop.hit.R__col.photo == 0, .01)) %>%
    ...
    ## Fam:
      exp5__col.photo.d.prime__fam <- exp5__test_stats %>%
          select(id, prop.hit.F__col.photo, prop.FA.F__col.photo) %>%
          mutate(prop.hit.F__col.photo = replace(prop.hit.F__col.photo, 
                                                    prop.hit.F__col.photo == 1, .99)) %>%
          mutate(prop.hit.F__col.photo = replace(prop.hit.F__col.photo, 
                                                    prop.hit.F__col.photo == 0, .01)) %>%
    ...
    ## Guess:
      exp5__col.photo.d.prime__guess <- exp5__test_stats %>%
          select(id, prop.hit.G__col.photo, prop.FA.G__col.photo) %>%
          mutate(prop.hit.G__col.photo = replace(prop.hit.G__col.photo, 
                                                    prop.hit.G__col.photo == 1, .99)) %>%
          mutate(prop.hit.G__col.photo = replace(prop.hit.G__col.photo, 
                                                    prop.hit.G__col.photo == 0, .01)) %>%
...
#----------------------------------------------------------------------------------------------------------------
      ...
      exp5__d.prime.R <- exp5__final_data %>%
      ...
      exp5__d.prime.F <- exp5__final_data %>%
      ...
      exp5__d.prime.G <- exp5__final_data %>%
...
##    Prep data for RFG d' figure:
      ...
      exp5__d.prime.R__grey.drawing <- 
          mean_se(exp5__d.prime.R %>% filter(stim == "grey.drawing") %>% pull(d.prime.R))
      exp5__d.prime.R__col.drawing <- 
        mean_se(exp5__d.prime.R %>% filter(stim == "col.drawing") %>% pull(d.prime.R))
      ...
      exp5__d.prime.F__grey.drawing <- 
          mean_se(exp5__d.prime.F %>% filter(stim == "grey.drawing") %>% pull(d.prime.F))
      exp5__d.prime.F__col.drawing <- 
        mean_se(exp5__d.prime.F %>% filter(stim == "col.drawing") %>% pull(d.prime.F))
      ...
      exp5__d.prime.G__grey.drawing <- 
          mean_se(exp5__d.prime.G %>% filter(stim == "grey.drawing") %>% pull(d.prime.G))
      exp5__d.prime.G__col.drawing <- 
        mean_se(exp5__d.prime.G %>% filter(stim == "col.drawing") %>% pull(d.prime.G))
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
    figure_numbering(name = "exp5__figure__rfg.hits", caption = "Mean proportion of hits and FAs by stimuli format.")
```
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__d.prime", caption = "Mean *d'* scores for regular and distinctive word stimuli, across the current experiment and @ensor2019b.", display = FALSE)
```      
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__hits", caption = "Mean proportion of hits for regular and distinctive word stimuli, across the current experiment and @ensor2019b.", display = FALSE)
```      
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__FAs", caption = "Mean proportion of FAs for regular and distinctive word stimuli, across the current experiment and @ensor2019b.", display = FALSE)
```
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__d.prime2", caption = "Mean *d;* scores for distinctive word stimuli and grey drawings, across the current experiment and @ensor2019b.", display = FALSE)
```
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__prop.hit2", caption = "Mean proportion of hits for distinctive word stimuli and grey drawings, across the current experiment and @ensor2019b.", display = FALSE)
```
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
      table_numbering(name = "exp5__table__ensor.vs.current__prop.FA2", caption = "Mean proportion of FAs for distinctive word stimuli and grey drawings, across the current experiment and @ensor2019b.", display = FALSE)
```
...
```{r echo=FALSE, results = FALSE, cache=FALSE}
    figure_numbering(name = "exp5__figure__rfg.d.prime", caption = "Mean d' scores by stimuli format and recognition judgement.")
```
...
, F [`r apa::anova_apa(exp5__prop.hit.F.aov, effect = "stim", format = "rmarkdown", print = FALSE)`], and G [`r apa::anova_apa(exp5__prop.hit.G.aov, effect = "stim", format = "rmarkdown", print = FALSE)`]. 


evidence of the distinctiveness manipulation;  Conversely, the regular words (*M* = `r exp5__prop.hit.F.means__grey.word`) showed a significantly higher proportion of F hits than the distinctive words (*M* = `r exp5__prop.hit.F.means__col.word`), `r apa::apa(exp5__prop.hit.F__ttest, format = "rmarkdown", print = FALSE)`. The planned comparisons did not show a significant difference in the number of hits assigned *Guessing* between distinctive words (*M* = `r exp5__prop.hit.G.means__col.word`) and regular words (*M* = `r exp5__prop.hit.G.means__grey.word`), `r apa::apa(exp5__prop.hit.G__ttest, format = "rmarkdown", print = FALSE)`.


For the proportion of FAs assigned R/F/G, each of the ANOVAs again showed significant main effects of stimuli format:, F (`r apa::anova_apa(exp5__prop.FA.F.aov, effect = "stim", format = "rmarkdown", print = FALSE)`), and G (`r apa::anova_apa(exp5__prop.FA.G.aov, effect = "stim", format = "rmarkdown", print = FALSE)`). 
