...
The picture stimuli utilised in the current study were created in Photoshop CC (20.0.04 Release), by importing the greyscale, surface-shaded, line-drawings onto a plain 250x250px white canvas. Written word stimuli were created using the Calibri sans-serif typeface on the same size canvas (see XXXX for example stimuli). All items were exported as .pngs files for presentation by the online survey platform.

```{r, echo=FALSE, results = FALSE, cache=FALSE}
    figure_numbering(name = "exp1__stim_examples",
                     caption = "Examples of @rossion2004 picture and word stimuli used in the current study.")
```
&nbsp;
&nbsp;
...
There was no significant main effect of response-option condition, `r exp1__apa_anova_prop_FA$full$ResponseOption`, or significant interaction, `r exp1__apa_anova_prop_FA$full$ResponseOption_StimuliFormat`. Click here to see output: [Appendix B - ANOVA Prop FAs][].
 There was no significant main effect of response-option condition, `r exp1__apa_anova_prop_recog$full$ResponseOption`, or significant interaction, `r exp1__apa_anova_prop_recog$full$ResponseOption_StimuliFormat`. Click here to see output: [Appendix C - ANOVA Overall recognition][].
