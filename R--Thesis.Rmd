...
##  Clear environment and list required packages:
    ...
    required_packages <- c("tidyverse", "dplyr", "captioner", "tinytex", "kableExtra", "formattable", 
                           "readr", "irr", "psycho", "afex", "emmeans", "janitor", "psych", "rstatix", "ggpubr")
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
      exp5__anova__PROP.HITS_data__row.id <- exp5__anova__PROP.HITS_data %>%
          rowid_to_column(., "temp")

      exp5__anova__PROP.HITS_data__outliers <- exp5__anova__PROP.HITS_data__row.id %>%
          group_by(stim_format, distinctiveness) %>%
          identify_outliers(hit) %>%
          filter(is.extreme == TRUE) %>%
          pull(temp)
      
      exp5__anova__PROP.HITS_data__outliers.removed <- exp5__anova__PROP.HITS_data__row.id %>%
          filter(!temp %in% exp5__anova__PROP.HITS_data__outliers)

      exp5__anova__PROP.HITS__outliers.removed <- aov_car(hit ~ stim_format*distinctiveness
                                                          + Error(id / stim_format*distinctiveness), 
                                                          data = exp5__anova__PROP.HITS_data__outliers.removed)
...
#----------------------------------------------------------------------------------------------------------------
      ...
      exp5__anova__PROP.HITS__distinctiveness.pairwise <- 
          pairs(exp5__anova__PROP.HITS__distinctiveness.means, adjust = "bonferroni")
#----------------------------------------------------------------------------------------------------------------
...
##    Contrasts:
      ...
      exp5__apa__anova__PROP.HITS__distinctiveness.means <- 
          papaja:::apa_print.emmGrid(exp5__anova__PROP.HITS__distinctiveness.means) 
      exp5__apa__anova__PROP.HITS__interaction.means <- 
          papaja:::apa_print.emmGrid(exp5__anova__PROP.HITS__interaction.means) 
      ...
      exp5__apa__anova__PROP.HITS__low_dist.mean <-
          exp5__apa__anova__PROP.HITS__distinctiveness.means$estimate$Low %>% str_remove("\\,.*")
      exp5__apa__anova__PROP.HITS__high_dist.mean <-
          exp5__apa__anova__PROP.HITS__distinctiveness.means$estimate$High %>% str_remove("\\,.*")
```
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
      knitr::kable(nice(exp5__anova__PROP.HITS__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.FA_data__row.id <- exp5__anova__PROP.FA_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.FA_data__outliers <- exp5__anova__PROP.FA_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(FA) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.FA_data__outliers.removed <- exp5__anova__PROP.FA_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.FA_data__outliers)

exp5__anova__PROP.FA__outliers.removed <- aov_car(FA ~ stim_format*distinctiveness
                                                    + Error(id / stim_format*distinctiveness), 
                                                    data = exp5__anova__PROP.FA_data__outliers.removed)
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.FA__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.RECOG_data__row.id <- exp5__anova__PROP.RECOG_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.RECOG_data__outliers <- exp5__anova__PROP.RECOG_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(recog) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.RECOG_data__outliers.removed <- exp5__anova__PROP.RECOG_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.RECOG_data__outliers)

exp5__anova__PROP.RECOG__outliers.removed <- aov_car(recog ~ stim_format*distinctiveness
                                                  + Error(id / stim_format*distinctiveness), 
                                                  data = exp5__anova__PROP.RECOG_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.RECOG__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.D.PRIME_data__row.id <- exp5__anova__PROP.D.PRIME_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.D.PRIME_data__outliers <- exp5__anova__PROP.D.PRIME_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(d.prime) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.D.PRIME_data__outliers.removed <- exp5__anova__PROP.D.PRIME_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.D.PRIME_data__outliers)

exp5__anova__PROP.D.PRIME__outliers.removed <- aov_car(d.prime ~ stim_format*distinctiveness
                                                  + Error(id / stim_format*distinctiveness), 
                                                  data = exp5__anova__PROP.D.PRIME_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.D.PRIME__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.C_data__row.id <- exp5__anova__PROP.C_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.C_data__outliers <- exp5__anova__PROP.C_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(c) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.C_data__outliers.removed <- exp5__anova__PROP.C_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.C_data__outliers)

exp5__anova__PROP.C__outliers.removed <- aov_car(c ~ stim_format*distinctiveness
                                                     + Error(id / stim_format*distinctiveness), 
                                                     data = exp5__anova__PROP.C_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.C__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.REC.HIT_data__row.id <- exp5__anova__PROP.REC.HIT_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.REC.HIT_data__outliers <- exp5__anova__PROP.REC.HIT_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(rec_hit) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.REC.HIT_data__outliers.removed <- exp5__anova__PROP.REC.HIT_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.REC.HIT_data__outliers)

exp5__anova__PROP.REC.HIT__outliers.removed <- aov_car(rec_hit ~ stim_format*distinctiveness
                                                     + Error(id / stim_format*distinctiveness), 
                                                     data = exp5__anova__PROP.REC.HIT_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.REC.HIT__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.FAM.HIT_data__row.id <- exp5__anova__PROP.FAM.HIT_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.FAM.HIT_data__outliers <- exp5__anova__PROP.FAM.HIT_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(fam_hit) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.FAM.HIT_data__outliers.removed <- exp5__anova__PROP.FAM.HIT_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.FAM.HIT_data__outliers)

exp5__anova__PROP.FAM.HIT__outliers.removed <- aov_car(fam_hit ~ stim_format*distinctiveness
                                                       + Error(id / stim_format*distinctiveness), 
                                                       data = exp5__anova__PROP.FAM.HIT_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.FAM.HIT__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.GUESS.HIT_data__row.id <- exp5__anova__PROP.GUESS.HIT_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.GUESS.HIT_data__outliers <- exp5__anova__PROP.GUESS.HIT_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(guess_hit) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.GUESS.HIT_data__outliers.removed <- exp5__anova__PROP.GUESS.HIT_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.GUESS.HIT_data__outliers)

exp5__anova__PROP.GUESS.HIT__outliers.removed <- aov_car(guess_hit ~ stim_format*distinctiveness
                                                       + Error(id / stim_format*distinctiveness), 
                                                       data = exp5__anova__PROP.GUESS.HIT_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.GUESS.HIT__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.REC.FA_data__row.id <- exp5__anova__PROP.REC.FA_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.REC.FA_data__outliers <- exp5__anova__PROP.REC.FA_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(rec_FA) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.REC.FA_data__outliers.removed <- exp5__anova__PROP.REC.FA_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.REC.FA_data__outliers)

exp5__anova__PROP.REC.FA__outliers.removed <- aov_car(rec_FA ~ stim_format*distinctiveness
                                                       + Error(id / stim_format*distinctiveness), 
                                                       data = exp5__anova__PROP.REC.FA_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.REC.FA__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.FAM.FA_data__row.id <- exp5__anova__PROP.FAM.FA_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.FAM.FA_data__outliers <- exp5__anova__PROP.FAM.FA_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(fam_FA) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.FAM.FA_data__outliers.removed <- exp5__anova__PROP.FAM.FA_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.FAM.FA_data__outliers)

exp5__anova__PROP.FAM.FA__outliers.removed <- aov_car(fam_FA ~ stim_format*distinctiveness
                                                       + Error(id / stim_format*distinctiveness), 
                                                       data = exp5__anova__PROP.FAM.FA_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.FAM.FA__outliers.removed))
```
...
#   Identify outliers:
#----------------------------------------------------------------------------------------------------------------
exp5__anova__PROP.GUESS.FA_data__row.id <- exp5__anova__PROP.GUESS.FA_data %>%
  rowid_to_column(., "temp")

exp5__anova__PROP.GUESS.FA_data__outliers <- exp5__anova__PROP.GUESS.FA_data__row.id %>%
  group_by(stim_format, distinctiveness) %>%
  identify_outliers(guess_FA) %>%
  filter(is.extreme == TRUE) %>%
  pull(temp)

exp5__anova__PROP.GUESS.FA_data__outliers.removed <- exp5__anova__PROP.GUESS.FA_data__row.id %>%
  filter(!temp %in% exp5__anova__PROP.GUESS.FA_data__outliers)

exp5__anova__PROP.GUESS.FA__outliers.removed <- aov_car(guess_FA ~ stim_format*distinctiveness
                                                       + Error(id / stim_format*distinctiveness), 
                                                       data = exp5__anova__PROP.GUESS.FA_data__outliers.removed)
#----------------------------------------------------------------------------------------------------------------
#   Contrasts:
#----------------------------------------------------------------------------------------------------------------
...
# Outliers removed:
```{r, echo=FALSE, cache=FALSE}
knitr::kable(nice(exp5__anova__PROP.GUESS.FA__outliers.removed))
```
