...
Visual comparison of the data (and significant results) across Experiments 3 and 4 reveals only one difference with regard to response option: *d'* scores failed to produce significant interaction effects between stimuli format and response option in the current experiment, as were previously demonstrated in Experiment 3.
