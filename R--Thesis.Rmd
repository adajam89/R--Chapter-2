...
#----------------------------------------------------------------------------------------------------------------
##  D-prime: 
    exp5__anova.d_prime__data <- exp5__final_data %>%
        ...
        gather(key = "stim_format", value = "d_prime", 
                    exp5__grey_word_d_prime, exp5__distinctive_word_d_prime, exp5__grey_drawing_d_prime, 
                    exp5__col_drawing_d_prime, exp5__grey_photo_d_prime, exp5__col_photo_d_prime) %>%
        transform(stim_format = factor(stim_format, levels=c("exp5__grey_word_d_prime",
                                                             "exp5__distinctive_word_d_prime",
                                                             "exp5__grey_drawing_d_prime",
                                                             "exp5__col_drawing_d_prime",
                                                             "exp5__grey_photo_d_prime", 
                                                             "exp5__col_photo_d_prime"))) %>%
        mutate(stim_format = str_remove(stim_format, "exp5__"))

    # Compute ANOVA:
        exp5__anova.d_prime <- summary(aov(d_prime ~ stim_format, data = exp5__anova.d_prime__data))
    # Pairwise:
        exp5__anova.d_prime__q1.pairwise.data <- exp5__anova.d_prime__data %>%
            filter(stim_format == "grey_word_d_prime" | stim_format == "distinctive_word_d_prime")
        exp5__anova.d_prime__q1.pairwise <- pairwise.t.test(exp5__anova.d_prime__q1.pairwise.data$d_prime, 
                                                      exp5__anova.d_prime__q1.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.d_prime__q2.pairwise.data <- exp5__anova.d_prime__data %>%
            filter(stim_format == "grey_word_d_prime" | stim_format == "grey_drawing_d_prime")
        exp5__anova.d_prime__q2.pairwise <- pairwise.t.test(exp5__anova.d_prime__q2.pairwise.data$d_prime, 
                                                      exp5__anova.d_prime__q2.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.d_prime__q3.pairwise.data <- exp5__anova.d_prime__data %>%
            filter(stim_format == "distinctive_word_d_prime" | stim_format == "grey_drawing_d_prime")
        exp5__anova.d_prime__q3.pairwise <- pairwise.t.test(exp5__anova.d_prime__q3.pairwise.data$d_prime, 
                                                      exp5__anova.d_prime__q3.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        
        exp5__anova.d_prime__means <- group_by(exp5__anova.d_prime__data, stim_format) %>%
            summarise(count = n(), mean = mean(d_prime, na.rm = TRUE), sd = sd(d_prime, na.rm = TRUE))
        exp5__anova.d_prime__means__grey_word <- exp5__anova.d_prime__means %>%
                                                    filter(stim_format == "grey_word_d_prime") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.d_prime__means__distinctive_word <- exp5__anova.d_prime__means %>%
                                                    filter(stim_format == "distinctive_word_d_prime") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.d_prime__means__grey_drawing <- exp5__anova.d_prime__means %>%
                                                    filter(stim_format == "grey_drawing_d_prime") %>%
                                                    select(mean) %>% pull() %>% round(2)
        
##  c: 
    exp5__anova.c__data <- exp5__final_data %>%
        select(id, grey_word_c, distinctive_word_c, grey_drawing_c,
               col_drawing_c, grey_photo_c, col_photo_c) %>%
        gather(key = "stim_format", value = "c", 
                    grey_word_c, distinctive_word_c, grey_drawing_c, 
                    col_drawing_c, grey_photo_c, col_photo_c) %>%
        transform(stim_format = factor(stim_format, levels=c("grey_word_c",
                                                             "distinctive_word_c",
                                                             "grey_drawing_c",
                                                             "col_drawing_c",
                                                             "grey_photo_c", 
                                                             "col_photo_c")))
    # Compute ANOVA:
        exp5__anova.c <- summary(aov(c ~ stim_format, data = exp5__anova.c__data))
    # Pairwise:
        exp5__anova.c__q1.pairwise.data <- exp5__anova.c__data %>%
            filter(stim_format == "grey_word_c" | stim_format == "distinctive_word_c")
        exp5__anova.c__q1.pairwise <- pairwise.t.test(exp5__anova.c__q1.pairwise.data$c, 
                                                      exp5__anova.c__q1.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.c__q2.pairwise.data <- exp5__anova.c__data %>%
            filter(stim_format == "grey_word_c" | stim_format == "grey_drawing_c")
        exp5__anova.c__q2.pairwise <- pairwise.t.test(exp5__anova.c__q2.pairwise.data$c, 
                                                      exp5__anova.c__q2.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.c__q3.pairwise.data <- exp5__anova.c__data %>%
            filter(stim_format == "distinctive_word_c" | stim_format == "grey_drawing_c")
        exp5__anova.c__q3.pairwise <- pairwise.t.test(exp5__anova.c__q3.pairwise.data$c, 
                                                      exp5__anova.c__q3.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)    
        
        exp5__anova.c__means <- group_by(exp5__anova.c__data, stim_format) %>%
            summarise(count = n(), mean = mean(c, na.rm = TRUE), sd = sd(c, na.rm = TRUE))
        exp5__anova.c__means__grey_word <- exp5__anova.c__means %>%
                                                    filter(stim_format == "grey_word_c") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.c__means__distinctive_word <- exp5__anova.c__means %>%
                                                    filter(stim_format == "distinctive_word_c") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.c__means__grey_drawing <- exp5__anova.c__means %>%
                                                    filter(stim_format == "grey_drawing_c") %>%
                                                    select(mean) %>% pull() %>% round(2)
        
##  Hit:    
    exp5__anova.hit__data <- exp5__final_data %>%
        select(id, prop_grey_word_hit, prop_distinctive_word_hit, prop_grey_drawing_hit,
               prop_col_drawing_hit, prop_grey_photo_hit, prop_col_photo_hit) %>%
        gather(key = "stim_format", value = "hit", 
                    prop_grey_word_hit, prop_distinctive_word_hit, prop_grey_drawing_hit, 
                    prop_col_drawing_hit, prop_grey_photo_hit, prop_col_photo_hit) %>%
        transform(stim_format = factor(stim_format, levels=c("prop_grey_word_hit", "prop_distinctive_word_hit",
                                                             "prop_grey_drawing_hit", "prop_col_drawing_hit",
                                                             "prop_grey_photo_hit", "prop_col_photo_hit")))
    # Compute ANOVA:
        exp5__anova.hit <- summary(aov(hit ~ stim_format, data = exp5__anova.hit__data))
    # Pairwise:
        exp5__anova.hit__q1.pairwise.data <- exp5__anova.hit__data %>%
            filter(stim_format == "prop_grey_word_hit" | stim_format == "prop_distinctive_word_hit")
        exp5__anova.hit__q1.pairwise <- pairwise.t.test(exp5__anova.hit__q1.pairwise.data$hit, 
                                                      exp5__anova.hit__q1.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.hit__q2.pairwise.data <- exp5__anova.hit__data %>%
            filter(stim_format == "prop_grey_word_hit" | stim_format == "prop_grey_drawing_hit")
        exp5__anova.hit__q2.pairwise <- pairwise.t.test(exp5__anova.hit__q2.pairwise.data$hit, 
                                                      exp5__anova.hit__q2.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        
        exp5__anova.hit__q3.pairwise.data <- exp5__anova.hit__data %>%
            filter(stim_format == "prop_distinctive_word_hit" | stim_format == "prop_grey_drawing_hit")
        exp5__anova.hit__q3.pairwise <- pairwise.t.test(exp5__anova.hit__q3.pairwise.data$hit, 
                                                      exp5__anova.hit__q3.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.hit__means <- group_by(exp5__anova.hit__data, stim_format) %>%
            summarise(count = n(), mean = mean(hit, na.rm = TRUE), sd = sd(hit, na.rm = TRUE))
        exp5__anova.hit__means__grey_word <- exp5__anova.hit__means %>%
                                                    filter(stim_format == "prop_grey_word_hit") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.hit__means__distinctive_word <- exp5__anova.hit__means %>%
                                                    filter(stim_format == "prop_distinctive_word_hit") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.hit__means__grey_drawing <- exp5__anova.hit__means %>%
                                                    filter(stim_format == "prop_grey_drawing_hit") %>%
                                                    select(mean) %>% pull() %>% round(2)
        
##  FA:    
    exp5__anova.FA__data <- exp5__final_data %>%
        ...
        gather(key = "stim_format", value = "FA", 
                    prop_grey_word_FA, prop_distinctive_word_FA, prop_grey_drawing_FA, 
                    prop_col_drawing_FA, prop_grey_photo_FA, prop_col_photo_FA) %>%
        transform(stim_format = factor(stim_format, levels=c("prop_grey_word_FA", "prop_distinctive_word_FA",
                                                             "prop_grey_drawing_FA", "prop_col_drawing_FA",
                                                             "prop_grey_photo_FA", "prop_col_photo_FA")))
    # Compute ANOVA:
        exp5__anova.FA <- summary(aov(FA ~ stim_format, data = exp5__anova.FA__data))
# Pairwise:
        exp5__anova.FA__q1.pairwise.data <- exp5__anova.FA__data %>%
            filter(stim_format == "prop_grey_word_FA" | stim_format == "prop_distinctive_word_FA")
        exp5__anova.FA__q1.pairwise <- pairwise.t.test(exp5__anova.FA__q1.pairwise.data$FA, 
                                                      exp5__anova.FA__q1.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.FA__q2.pairwise.data <- exp5__anova.FA__data %>%
            filter(stim_format == "prop_grey_word_FA" | stim_format == "prop_grey_drawing_FA")
        exp5__anova.FA__q2.pairwise <- pairwise.t.test(exp5__anova.FA__q2.pairwise.data$FA, 
                                                      exp5__anova.FA__q2.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.FA__q3.pairwise.data <- exp5__anova.FA__data %>%
            filter(stim_format == "prop_distinctive_word_FA" | stim_format == "prop_grey_drawing_FA")
        exp5__anova.FA__q3.pairwise <- pairwise.t.test(exp5__anova.FA__q3.pairwise.data$FA, 
                                                      exp5__anova.FA__q3.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.FA__means <- group_by(exp5__anova.FA__data, stim_format) %>%
            summarise(count = n(), mean = mean(FA, na.rm = TRUE), sd = sd(FA, na.rm = TRUE))
        exp5__anova.FA__means__grey_word <- exp5__anova.FA__means %>%
                                                    filter(stim_format == "prop_grey_word_FA") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.FA__means__distinctive_word <- exp5__anova.FA__means %>%
                                                    filter(stim_format == "prop_distinctive_word_FA") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.FA__means__grey_drawing <- exp5__anova.FA__means %>%
                                                    filter(stim_format == "prop_grey_drawing_FA") %>%
                                                    select(mean) %>% pull() %>% round(2)      
        
##  Recog:    
    exp5__anova.recog__data <- exp5__final_data %>%
        select(id, grey_word_recog, distinctive_word_recog, grey_drawing_recog,
               col_drawing_recog, grey_photo_recog, col_photo_recog) %>%
        gather(key = "stim_format", value = "recog", 
                    grey_word_recog, distinctive_word_recog, grey_drawing_recog, 
                    col_drawing_recog, grey_photo_recog, col_photo_recog) %>%
        transform(stim_format = factor(stim_format, levels=c("grey_word_recog",
                                                                "distinctive_word_recog",
                                                                "grey_drawing_recog",
                                                                "col_drawing_recog",
                                                                "grey_photo_recog",
                                                                "col_photo_recog")))
    # Compute ANOVA:
        exp5__anova.recog <- summary(aov(recog ~ stim_format, data = exp5__anova.recog__data))
    # Pairwise:
        exp5__anova.recog__q1.pairwise.data <- exp5__anova.recog__data %>%
            filter(stim_format == "grey_word_recog" | stim_format == "distinctive_word_recog")
        exp5__anova.recog__q1.pairwise <- pairwise.t.test(exp5__anova.recog__q1.pairwise.data$recog, 
                                                      exp5__anova.recog__q1.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.recog__q2.pairwise.data <- exp5__anova.recog__data %>%
            filter(stim_format == "grey_word_recog" | stim_format == "grey_drawing_recog")
        exp5__anova.recog__q2.pairwise <- pairwise.t.test(exp5__anova.recog__q2.pairwise.data$recog, 
                                                      exp5__anova.recog__q2.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        
        exp5__anova.recog__q3.pairwise.data <- exp5__anova.recog__data %>%
            filter(stim_format == "distinctive_word_recog" | stim_format == "grey_drawing_recog")
        exp5__anova.recog__q3.pairwise <- pairwise.t.test(exp5__anova.recog__q3.pairwise.data$recog, 
                                                      exp5__anova.recog__q3.pairwise.data$stim_format, 
                                                      pool.sd = FALSE)
        exp5__anova.recog__means <- group_by(exp5__anova.recog__data, stim_format) %>%
            summarise(count = n(), mean = mean(recog, na.rm = TRUE), sd = sd(recog, na.rm = TRUE))
        exp5__anova.recog__means__grey_word <- exp5__anova.recog__means %>%
                                                    filter(stim_format == "grey_word_recog") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.recog__means__distinctive_word <- exp5__anova.recog__means %>%
                                                    filter(stim_format == "distinctive_word_recog") %>%
                                                    select(mean) %>% pull() %>% round(2)
        exp5__anova.recog__means__grey_drawing <- exp5__anova.recog__means %>%
                                                    filter(stim_format == "grey_drawing_recog") %>%
                                                    select(mean) %>% pull() %>% round(2)
```
***Recap: Ensor replication***

- Grey words + distinctive words (colour, font, size) + grey drawings + colour drawings.
- Found PSE could be eliminated for grey drawings when distinctive words were used. 
- PSE *reduced* for colour drawings when distinctive words were used.

- Is this effect also evident using photos?
- If photos remain the most distinctive, is the PSE also *reduced* here when distinctive words are used?

Four research questions:

**Q1. Are the 'distinctive' words actually more distinctive than grey words?**

**Q2. Have I established a PSE?**

**Q3. Have I managed to eliminate PSE in the same way Ensor has? (i.e. are 'distinctive' words just as distinctive as grey drawings?**

**Q4. Have I extended it to photos? (i.e. is the 'better' PSE of photos reduced when distinctive words are used instead of grey ones?)**

\newpage
**Q1. Are the 'distinctive' words actually more distinctive than grey words?**

1. **d-prime:**
    + i) ***Yes:*** Distinctive words (`r exp5__anova.d_prime__means__distinctive_word`) had significantly higher d' scores than grey words (`r exp5__anova.d_prime__means__grey_word`). 

2. **c scores:**
    + i) ***No:*** Distinctive words (`r exp5__anova.c__means__distinctive_word`) had significantly higher c-scores (and thus a more conservative response bias) than grey words (`r exp5__anova.c__means__grey_word`). 

3. **Hits:**
    + i) ***No:*** No difference in the number of hits between distinctive words (`r exp5__anova.hit__means__distinctive_word`) and grey words (`r exp5__anova.hit__means__grey_word`).
    
4. **FA:**
    + i) ***Yes:*** Distinctive words (`r exp5__anova.FA__means__distinctive_word`) had significantly fewer FAs than grey words (`r exp5__anova.FA__means__grey_word`). 

5. **Recog:**
    + i) ***Yes.*** Distinctive words (`r exp5__anova.recog__means__distinctive_word`) had significantly higher overall recognition scores than grey words (`r exp5__anova.recog__means__grey_word`). 
...
1. **d-prime:**
    + i) ***Yes:*** Grey drawings (`r exp5__anova.d_prime__means__grey_drawing`) had significantly higher d' scores than grey words (`r exp5__anova.d_prime__means__grey_word`).   
    
 2. **c scores:**
    + i) ***No:*** No difference in c scores between grey drawings (`r exp5__anova.c__means__grey_drawing`) and grey words (`r exp5__anova.c__means__grey_word`).
    
 3. **Hits:**
    + i) ***Yes:*** Grey drawings (`r exp5__anova.hit__means__grey_drawing`) had significantly more hits than grey words (`r exp5__anova.hit__means__grey_word`).
    
4. **FAs:**
    + i) ***Yes.*** Grey drawings (`r exp5__anova.FA__means__grey_drawing`) had significantly fewer FAs than grey words (`r exp5__anova.FA__means__grey_word`).

5. **Recog:**
    + i) ***Yes.*** Grey drawings (`r exp5__anova.recog__means__grey_drawing`) had significantly higher overall recognition scores than grey words (`r exp5__anova.recog__means__grey_word`).
...
1. **d-prime:**
    + i) ***No:*** Distinctive words (`r exp5__anova.d_prime__means__distinctive_word`) had significantly lower d' scores than grey drawings (`r exp5__anova.d_prime__means__grey_drawing`). 
    + ii) Different to Ensor (who found no difference, i.e. the PSE was eliminated).
    + iii) Ensor (Distinctive words = 2.97, Grey drawings =  2.96). 
        
2. **c scores:**
    + i) ***Not sure:*** Distinctive words (`r exp5__anova.c__means__distinctive_word`) had significantly higher c scores (responses were more conservative) than grey drawings (`r exp5__anova.c__means__grey_drawing`). 
    + ii) Ensor found different results across experiments. My finding here is the same pattern as they found in in Exp 2 (Distinctive words = –.005, Grey drawings =  .106). 

3. **Hits:**
    + i) ***No:*** Distinctive words (`r exp5__anova.hit__means__distinctive_word`) had significantly fewer hits than grey drawings (`r exp5__anova.hit__means__grey_drawing`).
    + ii) Ensor (Distinctive words = .83, Grey drawings =  .85). 
        
4. **FAs:**
    + i) ***Yes.*** Distinctive words (`r exp5__anova.FA__means__distinctive_word`) had significantly fewer FAs than grey drawings (`r exp5__anova.FA__means__grey_drawing`). 
    + ii) Ensor (Did not analyse, but: Distinctive words = .09, Grey drawings =  .12). 

5. **Recog:**
    + i) ***No.*** Distinctive words (`r exp5__anova.recog__means__distinctive_word`) had significantly lower overall recognition scores than grey drawings (`r exp5__anova.recog__means__grey_drawing`). 

\newpage

Our results somewhat match previous findings by Paivio et al (1968):

- they just added colour to words, and did not observe any increased distinctiveness. BUT, findings from Experiments 3 + 4 already suggest the effects of colour are negligible.
- Ensor noted this, and that's why they also manipulated font, size, capitalisation *and* colour.

On the surface, my findings appear to support Dual-coding theory (DCT):

   - 2 independent pathways in memory: verbal representations (logogen) + mental images (imagen).
   - Pictures are far more likely to generate representations in both pathways (mental image + name of the object) than words are (name of object + imagine a word’s referent), resulting in PSE. 
   - The distinctiveness manipulations made to the words do nothing to remove the additional code available for pictures - so pictures are always better. 
   
However, the results of Experiments 3, 4, + 5 all show that photos are recognised better than words!

  - Strong evidence for the distinctiveness account.
  - The 'distinctive' word stim used in Exp 5. must indeed be more distinctive than regular words, but not to the extent that the PSE is eliminated (like Ensor found).

Explanations of these inconsistent findings:

  - Participants in my experiment responded to 6 stim types, vs. Ensor's 4.
      - Overall more difficult? Though I would expect this to reduce overall performance, rather than any stim-specific changes. 
  - Number of stim (10x of each type) = same as Ensor's Exp 1.
      - But our extra stim formats mean P saw 20 more items at study and 40 more items at test than Ensor.
      - Ensor's doubled thier stim in Exp 2, which strenghtened their findings (also eliminated the PSE toward *colour* drawings).  
  - My *N* = 168 vs. Ensor's *N* = 30.

Are the distinctive words readable?
 - But how would that explain the difference between my findings and Ensor? 
