...
```
**Guessinm (hits):** For G hits, there was a significant interaction between stimuli format and response option option condition, `r apa::anova_apa(exp1__prop.hit.G.aov, effect = "resp_option:stim", format = "rmarkdown", print = FALSE)` (see `r figure_numbering("exp1__prop.hit.G__interaction.figure", display = "cite")`).
