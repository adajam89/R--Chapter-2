...
#### Distinctiveness
To determine whether colour photographs were more distinctive than colour drawings (and examine whether the availability of different response options had similar effects toward colour items as in the previous experiment using greyscale stimuli), a series of 2 (stimuli format: words, pictures) x 3 (response option condition: RFG-judgements, RFBG-judgements, RF-ratings) mixed ANOVAs were conducted on the signal detection measures of *d'* (sensitivity) and *c* (decision criterion), as well as the proportion of overall hits, false alarms (FAs), and overall recognition (hits - FAs) [see `r table_numbering("exp4__hit.FA.recog.table", display = "cite")`]. Significant main effects and interaction effects were followed-up with Bonferroni-adjusted pairwise comparisons.
...
#------------------------------------------------------------------------------------------------------------------
      exp4__ANOVA.table <- tribble(
          ~"", ~"ANOVA result", ~"Drawings", ~"Photographs",  ~"Pairwise",
          "d'",                   exp4__apa_anova_d_prime__stim_format,
                                  exp4__drawings_d_prime_mean,
                                  exp4__photos_d_prime_mean,
                                  exp4__drawings_photo_d_prime_ttest,
          "c",                    exp4__apa_anova_c__stim_format,
                                  exp4__drawings_c_mean,
                                  exp4__photos_c_mean,
                                  exp4__drawings_photo_c_ttest,
          "Proportion of hits",   exp4__apa_anova_prop_hit__stim_format,
                                  exp4__drawings_prop_hit_mean,
                                  exp4__photos_prop_hit_mean,
                                  exp4__drawings_photo_hit_ttest, 
          "Proportion of FAs",    exp4__apa_anova_prop_FA__stim_format,
                                  exp4__drawings_prop_FA_mean,
                                  exp4__photos_prop_FA_mean,
                                  exp4__drawings_photo_FA_ttest,
          "Overall recognition",  exp4__apa_anova_recog__stim_format,
                                  exp4__drawings_recog_mean,
                                  exp4__photos_recog_mean,
                                  exp4__drawings_photo_recog_ttest)
```
...
Such differences were also statistically significant. 
...
Overall recognition performance (taking into account hits and FAs) offered further support for a distinctiveness effect; a significant main effect of stimuli-format 

photographs produced better overall task performance compared to drawings. Taken together, the findings support the distinctiveness hypothesis, in that colour photographs were recognised better than colour drawings. 

 These patterns support the notion that distinctiveness plays a key role in the memorability of stimuli, and also that the current stimuli indeed appear to capture different 'levels' of stimuli distinctiveness. 

drawings showing higher *c*-scores (and thus a more conservative response bias) than photographs 
