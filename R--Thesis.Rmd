...
```{r echo=FALSE, results = FALSE, cache=FALSE}
    figure_numbering(name = "exp5__manip.check__figure", caption = "Mean proportion of hits and FAs by stimuli format.")
```
...
In the ANOVAs on the proportion of R/F/G hits, there was a significant main effect of stimuli format for hits assigned R [`r apa::anova_apa(exp5__prop.hit.R.aov, effect = "stim", format = "rmarkdown", print = FALSE)`], F [`r apa::anova_apa(exp5__prop.hit.F.aov, effect = "stim", format = "rmarkdown", print = FALSE)`], and G [`r apa::anova_apa(exp5__prop.hit.G.aov, effect = "stim", format = "rmarkdown", print = FALSE)`]. Planned comparisons showed evidence of the distinctiveness manipulation; distinctive words (*M* = `r exp5__prop.hit.R.means__col.word`) produced significantly more R hits than regular words (*M* = `r exp5__prop.hit.R.means__grey.word`), `r apa::apa(exp5__prop.hit.R__ttest, format = "rmarkdown", print = FALSE)`. Conversely, the regular words (*M* = `r exp5__prop.hit.F.means__grey.word`) showed a significantly higher proportion of F hits than the distinctive words (*M* = `r exp5__prop.hit.F.means__col.word`), `r apa::apa(exp5__prop.hit.F__ttest, format = "rmarkdown", print = FALSE)`. The planned comparisons did not show a significant difference in the number of hits assigned *Guessing* between distinctive words (*M* = `r exp5__prop.hit.G.means__col.word`) and regular words (*M* = `r exp5__prop.hit.G.means__grey.word`), `r apa::apa(exp5__prop.hit.G__ttest, format = "rmarkdown", print = FALSE)`.
...
For the proportion of FAs assigned R/F/G, each of the ANOVAs again showed significant main effects of stimuli format: R (`r apa::anova_apa(exp5__prop.FA.R.aov, effect = "stim", format = "rmarkdown", print = FALSE)`), F (`r apa::anova_apa(exp5__prop.FA.F.aov, effect = "stim", format = "rmarkdown", print = FALSE)`), and G (`r apa::anova_apa(exp5__prop.FA.G.aov, effect = "stim", format = "rmarkdown", print = FALSE)`). There was again evidence of the distinctiveness manipulation; regular words (*M* = `r exp5__prop.FA.R.means__grey.word`) produced a significantly higher proportion of FAs assigned R than distinctive words (*M* = `r exp5__prop.FA.R.means__col.word`), `r apa::apa(exp5__prop.FA.R__ttest, format = "rmarkdown", print = FALSE)`. Likewise, there were more FAs assigned F for regular words (*M* = `r exp5__prop.FA.F.means__grey.word`) compared to the distinctive words (*M* = `r exp5__prop.FA.F.means__col.word`), `r apa::apa(exp5__prop.FA.F__ttest, format = "rmarkdown", print = FALSE)`. As before, the follow up comparisomns showed no difference in the number of FAs assigned G between distinctive (*M* = `r exp5__prop.FA.G.means__col.word`) and regular words (*M* = `r exp5__prop.FA.G.means__grey.word`), `r apa::apa(exp5__prop.FA.G__ttest, format = "rmarkdown", print = FALSE)`.
