...
```{r, include=FALSE, warning = FALSE, message=FALSE, cache=TRUE}
      ...
      exp4__hit.FA.recog.table <- tribble(
          ...
          "RFG",          mean(exp4__colour__anova__PROP.HITS__rfg.totals$total_hit) / 60,
                          mean(exp4__colour__anova__PROP.HITS__rfg.totals$total_FA) / 60,
                          mean(exp4__RFG__totals$prop_RFG_hit),
          "RFBG",         mean(exp4__colour__anova__PROP.HITS__rfbg.totals$total_hit) / 60,
                          mean(exp4__colour__anova__PROP.HITS__rfbg.totals$total_FA) / 60,
...
#################################################################################################################  
##    Prep data for analysis:                                                 
      exp4__colour__anova__PROP.HITS_data <- exp4__colour_data %>%
          select(id, resp_option, prop_word_hit, prop_drawing_hit, prop_photo_hit) %>%
          rename(word = "prop_word_hit", drawing = "prop_drawing_hit", photo = "prop_photo_hit") %>%
          gather(key = "stim_format", value = "hit", word, drawing, photo) %>%
          mutate_at(vars("id", "resp_option", "stim_format"), factor) %>%
...
#---------------------------------------------------------------------------------------------------------------#
##    Run 2-way mixed ANOVA:
      exp4__colour__anova__PROP.HITS <- aov_ez("id", "hit", exp4__colour__anova__PROP.HITS_data,
                                               between = "resp_option", within = "stim_format")

##    Format ANOVA main effects for use in report:  
      exp4__apa__colour__anova__PROP.HITS <- papaja:::apa_print.afex_aov(exp4__colour__anova__PROP.HITS)
      exp4__apa__colour__anova__PROP.HITS__stim.format.main.effect <- 
          exp4__apa__colour__anova__PROP.HITS$full$stim_format 
      exp4__apa__colour__anova__PROP.HITS__resp.option.main.effect <- 
          exp4__apa__colour__anova__PROP.HITS$full$resp_option 
      exp4__apa__colour__anova__PROP.HITS__interaction.main.effect <- 
          exp4__apa__colour__anova__PROP.HITS$full$resp_option_stim_format
#---------------------------------------------------------------------------------------------------------------#
#     Run post-hoc contrasts                                                                                    
#---------------------------------------------------------------------------------------------------------------#
#-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  #
...
#-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  #
##    Stimuli format:
      exp4__colour__anova__PROP.HITS__stim.format.means <- emmeans(exp4__colour__anova__PROP.HITS, ~ stim_format)
      exp4__colour__anova__PROP.HITS__stim.format.pairwise <-
          pairs(exp4__colour__anova__PROP.HITS__stim.format.means, adjust = "bonferroni")

##    Format pairwise results for use in report:  
      exp4__apa__colour__anova__PROP.HITS__stim.format.means <- 
          papaja:::apa_print.emmGrid(exp4__colour__anova__PROP.HITS__stim.format.means) 
      exp4__apa__colour__anova__PROP.HITS__words.mean <- 
          exp4__apa__colour__anova__PROP.HITS__stim.format.means$estimate$Words %>% str_remove("\\,.*")
      exp4__apa__colour__anova__PROP.HITS__drawings.mean <- 
          exp4__apa__colour__anova__PROP.HITS__stim.format.means$estimate$Drawings %>% str_remove("\\,.*")
      exp4__apa__colour__anova__PROP.HITS__photographs.mean <- 
          exp4__apa__colour__anova__PROP.HITS__stim.format.means$estimate$Photographs %>% str_remove("\\,.*")
      exp4__apa__colour__anova__PROP.HITS__stim.format.pairwise <- 
          papaja:::apa_print.emmGrid(exp4__colour__anova__PROP.HITS__stim.format.pairwise)

      exp4__apa__colour__anova__PROP.HITS__words.vs.drawings.pairwise <-
          exp4__apa__colour__anova__PROP.HITS__stim.format.pairwise$full$Words_Drawings %>% 
          str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
      exp4__apa__colour__anova__PROP.HITS__words.vs.photographs.pairwise <-
        exp4__apa__colour__anova__PROP.HITS__stim.format.pairwise$full$Words_Photographs %>% 
        str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
      exp4__apa__colour__anova__PROP.HITS__drawings.vs.photographs.pairwise <-
        exp4__apa__colour__anova__PROP.HITS__stim.format.pairwise$full$Drawings_Photographs %>% 
        str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
#-  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  #
##    Interaction:  Not significant.
#---------------------------------------------------------------------------------------------------------------#
##    Prep data for figure:
      exp4__colour__anova__PROP.HITS__all.means <- emmeans(exp4__colour__anova__PROP.HITS,
                                                           c("resp_option", "stim_format"))
      exp4__colour__anova__PROP.HITS__figure.data <- as_tibble(exp4__colour__anova__PROP.HITS__all.means) %>%
        select(-df, -lower.CL, -upper.CL)

##    Prep data for table:  
      exp4__colour__anova__PROP.HITS__rfg.totals <- exp4__colour_data %>%
          filter(resp_option == "RFG") %>%
          mutate(total_hit = total_word_hit + total_drawing_hit + total_photo_hit) %>%
          mutate(total_FA = total_word_FA + total_drawing_FA + total_photo_FA)
      exp4__colour__anova__PROP.HITS__rfbg.totals <- exp4__colour_data %>%
          filter(resp_option == "RFBG") %>%
          mutate(total_hit = total_word_hit + total_drawing_hit + total_photo_hit) %>%
          mutate(total_FA = total_word_FA + total_drawing_FA + total_photo_FA)
...
For the proportion of total hits, there was a significant main effect of stimuli format [`r exp4__apa__colour__anova__PROP.HITS__stim.format.main.effect`]. The interaction effect was not significant [`r exp4__apa__colour__anova__PROP.HITS__interaction.main.effect`]. Post-hoc comparisons for the main effect of stimuli format showed that photographs (`r exp4__apa__colour__anova__PROP.HITS__photographs.mean`) produced a significantly higher proportion of hits than both words (`r exp4__apa__colour__anova__PROP.HITS__words.mean`) [`r exp4__apa__colour__anova__PROP.HITS__words.vs.photographs.pairwise`] and drawings (`r exp4__apa__colour__anova__PROP.HITS__drawings.mean`) [`r exp4__apa__colour__anova__PROP.HITS__drawings.vs.photographs.pairwise`]. Drawings (`r exp4__apa__colour__anova__PROP.HITS__drawings.mean`) also produced a significantly higher proportion of hits compared to words (`r exp4__apa__colour__anova__PROP.HITS__words.mean`) [`r exp4__apa__colour__anova__PROP.HITS__words.vs.drawings.pairwise`]. 
