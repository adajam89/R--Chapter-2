...
##  Captioner:
    ...
    appendix_numbering("d.prime.calc", "*d'* calculations", display = FALSE)
...
[see `r appendix_numbering("d.prime.calc", display = "cite")` for *d'* formula]. 
...
# Appendices
## `r appendix_numbering("d.prime.calc")`
