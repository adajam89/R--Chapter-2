...
##  Prep data for table:  
exp3__grey__anova__PROP.HITS__rfg.totals <- exp3__final.data %>%
...
exp3__grey__anova__PROP.HITS__rfbg.totals <- exp3__final.data %>%
...
exp3__grey__anova__PROP.HITS__table <- tribble(
  ~"Stim", ~Hits,  ~FAs,
  "Words", mean(exp3__final.data$prop_word_hit), mean(exp3__final.data$prop_word_FA),
  "Drawings", mean(exp3__final.data$prop_drawing_hit), mean(exp3__final.data$prop_drawing_FA),
  "Photographs", mean(exp3__final.data$prop_photo_hit), mean(exp3__final.data$prop_photo_FA),
...
exp3__grey__anova__RECOG_data <- exp3__final.data %>%
...
#################################################################################################################
##  Prep data for analysis:                                           
exp3__grey__anova__D.PRIME_data <- exp3__final.data %>%
...
#---------------------------------------------------------------------------------------------------------------#
##  Prep data for table:  
exp3__grey__anova__D.PRIME__rfg.totals <- exp3__final.data %>%
  filter(resp_option == "RFG") %>%
  mutate(total_d_prime = word_d_prime + drawing_d_prime + photo_d_prime) %>%
  mutate(total_c = word_c + drawing_c + photo_c)
exp3__grey__anova__D.PRIME__rfbg.totals <- exp3__final.data %>%
  filter(resp_option == "RFBG") %>%
  mutate(total_d_prime = word_d_prime + drawing_d_prime + photo_d_prime) %>%
  mutate(total_c = word_c + drawing_c + photo_c)
...
exp3__grey__anova__D.PRIME__table <- tribble(
  ~"Stim", ~"d'",  ~c,
  "Words", mean(exp3__final.data$word_d_prime), mean(exp3__final.data$word_c),
  "Drawings", mean(exp3__final.data$drawing_d_prime), mean(exp3__final.data$drawing_c),
  "Photographs", mean(exp3__final.data$photo_d_prime), mean(exp3__final.data$photo_c),
...
## Prep data for analysis:                                               
    exp3__grey__anova__C.SCORES_data <- exp3__final.data %>%
...
#################################################################################################################
##  Prep data for analysis:                                               
exp3__grey__anova__PROP.REC.HITS_data <- exp3__final.data %>%
...
#################################################################################################################
## Prep data for analysis:                                               
exp3__grey__anova__PROP.FAM.HITS_data <- exp3__final.data %>%
...
#################################################################################################################
## Prep data for analysis:                                               
exp3__grey__anova__PROP.GUESS.HITS_data <- exp3__final.data %>%
