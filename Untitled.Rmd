...
```{r include=FALSE, warning = FALSE, message=FALSE, cache=TRUE}
        RFG__totals <- exp1__full_data %>% 
            filter (resp_optiononseOption == "RFG") %>% 
        ...
        RFBG__totals <- exp1__full_data %>% 
            filter (resp_optiononseOption == "RFBG") %>% 
            select(total_hits, total_miss, total_FA, total_CR, 
                   exp1__word_d_prime, exp1__pic_d_prime, word_c, pic_c) %>%
        ...
        RFR__totals <- exp1__full_data %>% 
            filter (resp_optiononseOption == "RF_Ratings") %>% 
            select(total_hits, total_miss, total_FA, total_CR,
                   exp1__word_d_prime, exp1__pic_d_prime, word_c, pic_c) %>%
            mutate(prop_RFR_hit = total_hits / (total_hits + total_miss)) %>%
        ...
        exp1__hit.FA.recog.table <- tribble(
          ...
          "Words",      mean(exp1__full_data$exp1__word_d_prime),
                            mean(exp1__full_data$word_c),
                                mean(exp1__full_data$prop.hit__word), 
                                    mean(exp1__full_data$prop.FA__word),
                                        mean(exp1__full_data$recog__word),
          "Pictures",   mean(exp1__full_data$exp1__pic_d_prime),
                            mean(exp1__full_data$pic_c),
                                mean(exp1__full_data$prop.hit__pic), 
                                    mean(exp1__full_data$prop.FA__pic),
                                        mean(exp1__full_data$recog__pic),
...
###################################################################################################################
      exp1__rec_hit_anova_data <- exp1__full_data %>%
          select(id, resp_optiononseOption, prop.hit.R.total__pic, prop.hit.R.total__word) %>%
          rename(picture = "prop.hit.R.total__pic", word = "prop.hit.R.total__word") %>%
...
##    2-way mixed ANOVA:
      exp1__anova_prop_rec_hit <- aov_ez("id", "rec_hit", exp1__rec_hit_anova_data, between = "resp_optiononseOption",
                                         within = "stimuliFormat")
##    Post-hoc contrasts:
##    stimuli-format:
      exp1__anova_prop_rec_hit_stim_emmeans <- emmeans(exp1__anova_prop_rec_hit, ~ stimuliFormat)
      exp1__anova_prop_rec_hit_stim_pairwise <- pairs(exp1__anova_prop_rec_hit_stim_emmeans)
##    resp_optiononse-options:
      exp1__anova_prop_rec_hit_resp_option_emmeans <- emmeans(exp1__anova_prop_rec_hit, ~ resp_optiononseOption)
...
##    Interaction: 
      exp1__anova_prop_rec_hit_interaction_emmeans <- 
        emmeans(exp1__anova_prop_rec_hit, c("resp_optiononseOption", "stimuliFormat"))
      exp1__anova_prop_rec_hit_interaction_pairwise_resp_optionoption <- 
          emmeans(exp1__anova_prop_rec_hit, "resp_optiononseOption", by = "stimuliFormat")
      exp1__anova_prop_rec_hit_interaction_pairwise_resp_optionoption <- 
          pairs(exp1__anova_prop_rec_hit_interaction_pairwise_resp_optionoption)
      exp1__anova_prop_rec_hit_interaction_pairwise_stimformat <- 
          emmeans(exp1__anova_prop_rec_hit, "stimuliFormat", by = "resp_optiononseOption")
      exp1__anova_prop_rec_hit_interaction_pairwise_stimformat <- 
...
##    Main effects:
      ...
      exp1__apa_anova_prop_rec_hit$full$resp_optiononseOption <- exp1__apa_anova_prop_rec_hit$full$resp_optiononseOption
      exp1__apa_anova_prop_rec_hit$full$resp_optiononseOption_stimuliFormat <-
          exp1__apa_anova_prop_rec_hit$full$resp_optiononseOption_stimuliFormat
##    Pairwise (stim-format):
      exp1__apa_anova_prop_rec_hit_stim_emmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_rec_hit_stim_emmeans)
      exp1__pics_prop_rec_hit_mean <- exp1__apa_anova_prop_rec_hit_stim_emmeans$estimate$Pictures %>% 
          str_remove("\\,.*")
      exp1__words_prop_rec_hit_mean <- exp1__apa_anova_prop_rec_hit_stim_emmeans$estimate$Words %>% 
          str_remove("\\,.*")
      exp1__apa_anova_prop_rec_hit_stim_pairwise <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_rec_hit_stim_pairwise)
      exp1__pics_words_rec_hit_ttest <- exp1__apa_anova_prop_rec_hit_stim_pairwise$full %>% 
          str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
...
###################################################################################################################
      exp1__fam_hit_anova_data <- exp1__full_data %>%
          select(id, resp_optiononseOption, prop.hit.F.total__pic, prop.hit.F.total__word) %>%
          rename(picture = "prop.hit.F.total__pic", word = "prop.hit.F.total__word") %>%
...
##    Post-hoc contrasts:
##    stimuli-format:
      exp1__anova_prop_fam_hit_stim_emmeans <- emmeans(exp1__anova_prop_fam_hit, ~ stimuliFormat)
      exp1__anova_prop_fam_hit_stim_pairwise <- pairs(exp1__anova_prop_fam_hit_stim_emmeans)
##    resp_optiononse-options:
      exp1__anova_prop_fam_hit_resp_option_emmeans <- emmeans(exp1__anova_prop_fam_hit, ~ resp_optiononseOption)
...
##    Interaction: 
      exp1__anova_prop_fam_hit_interaction_emmeans <- 
          emmeans(exp1__anova_prop_fam_hit, c("resp_optiononseOption", "stimuliFormat"))
      exp1__anova_prop_fam_hit_interaction_pairwise_resp_optionoption <- 
          emmeans(exp1__anova_prop_fam_hit, "resp_optiononseOption", by = "stimuliFormat")
      exp1__anova_prop_fam_hit_interaction_pairwise_resp_optionoption <- 
          pairs(exp1__anova_prop_fam_hit_interaction_pairwise_resp_optionoption)
      exp1__anova_prop_fam_hit_interaction_pairwise_stimformat <- 
          emmeans(exp1__anova_prop_fam_hit, "stimuliFormat", by = "resp_optiononseOption")
      exp1__anova_prop_fam_hit_interaction_pairwise_stimformat <- 
...
##    Main effects:
      ...
      exp1__apa_anova_prop_fam_hit$full$resp_optiononseOption <- exp1__apa_anova_prop_fam_hit$full$resp_optiononseOption
      exp1__apa_anova_prop_fam_hit$full$resp_optiononseOption_stimuliFormat <- 
          exp1__apa_anova_prop_fam_hit$full$resp_optiononseOption_stimuliFormat
##    Pairwise (stim-format):
      exp1__apa_anova_prop_fam_hit_stim_emmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_fam_hit_stim_emmeans)
      exp1__pics_prop_fam_hit_mean <- exp1__apa_anova_prop_fam_hit_stim_emmeans$estimate$Pictures %>% 
          str_remove("\\,.*")
      exp1__words_prop_fam_hit_mean <- exp1__apa_anova_prop_fam_hit_stim_emmeans$estimate$Words %>% 
          str_remove("\\,.*")
      exp1__apa_anova_prop_fam_hit_stim_pairwise <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_fam_hit_stim_pairwise)
      exp1__pics_words_fam_hit_ttest <- exp1__apa_anova_prop_fam_hit_stim_pairwise$full %>% 
          str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
##    Pairwise (resp_option-option):
...
##    Pairwise (interaction):
      ...
      exp1__apa_anova_prop_fam_hit_interaction_pairwise_resp_optionoption <-
          papaja:::apa_print.emmGrid(exp1__anova_prop_fam_hit_interaction_pairwise_resp_optionoption)
#------------------------------------------------------------------------------------------------------------------
#   Interaction figure:
#------------------------------------------------------------------------------------------------------------------
...
##    Labels (replaces plot legend):
      exp1__fam_hit_interaction_figure_labels <- exp1__fam_hit_figure_data %>%
          select(stimuliFormat, resp_optiononseOption, emmean) %>%
          filter(stimuliFormat == "Pictures") %>%
          mutate(label = case_when(
              resp_optiononseOption == "RFG" ~ "RFG",
              resp_optiononseOption == "RFBG" ~ "RFBG",
              resp_optiononseOption == "RF_Ratings" ~ "RF Ratings")) %>%
          group_by(stimuliFormat, resp_optiononseOption, label)
##    Figure:
      exp1__fam_hit_interaction_figure <- exp1__fam_hit_figure_data %>%
          ggplot() +
          aes(x = stimuliFormat, color = resp_optiononseOption, group = resp_optiononseOption, y = emmean) +
          stat_summary(fun.y = mean, geom = "point", size = 2.4, shape = 15) +
          stat_summary(fun.y = mean, geom = "line", size = 1.2) +
          geom_text(size = 4, aes(label = label, color = resp_optiononseOption), nudge_x = 0.08, hjust = 0,
...
###################################################################################################################
      exp1__guess_hit_anova_data <- exp1__full_data %>%
          select(id, resp_optiononseOption, prop.hit.G__pic, prop.hit.G__word) %>%
          rename(picture = "prop.hit.G__pic", word = "prop.hit.G__word") %>%
...
##    Post-hoc contrasts:
##    stimuli-format:
      exp1__anova_prop_guess_hit_stim_emmeans <- emmeans(exp1__anova_prop_guess_hit, ~ stimuliFormat)
      exp1__anova_prop_guess_hit_stim_pairwise <- pairs(exp1__anova_prop_guess_hit_stim_emmeans)
##    resp_optiononse-options:
      exp1__anova_prop_guess_hit_resp_option_emmeans <- emmeans(exp1__anova_prop_guess_hit, ~ resp_optiononseOption)
...
##    Interaction (not significant, but used in bar chart):
      exp1__anova_prop_guess_hit_interaction_emmeans <- 
          emmeans(exp1__anova_prop_guess_hit, c("resp_optiononseOption", "stimuliFormat"))
      exp1__anova_prop_guess_hit_interaction_pairwise_resp_optionoption <- 
          emmeans(exp1__anova_prop_guess_hit, "resp_optiononseOption", by = "stimuliFormat")
      exp1__anova_prop_guess_hit_interaction_pairwise_resp_optionoption <- 
          pairs(exp1__anova_prop_guess_hit_interaction_pairwise_resp_optionoption)
      exp1__anova_prop_guess_hit_interaction_pairwise_stimformat <- 
          emmeans(exp1__anova_prop_guess_hit, "stimuliFormat", by = "resp_optiononseOption")
      exp1__anova_prop_guess_hit_interaction_pairwise_stimformat <- 
...
##    Main effects:
      ...
      exp1__apa_anova_prop_guess_hit$full$resp_optiononseOption <- exp1__apa_anova_prop_guess_hit$full$resp_optiononseOption
      exp1__apa_anova_prop_guess_hit$full$resp_optiononseOption_stimuliFormat <- 
          exp1__apa_anova_prop_guess_hit$full$resp_optiononseOption_stimuliFormat
##    Pairwise (stim-format):
      exp1__apa_anova_prop_guess_hit_stim_emmeans <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_hit_stim_emmeans)
      exp1__pics_prop_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_stim_emmeans$estimate$Pictures %>%
          str_remove("\\,.*")
      exp1__words_prop_guess_hit_mean <- exp1__apa_anova_prop_guess_hit_stim_emmeans$estimate$Words %>%
          str_remove("\\,.*")
      exp1__apa_anova_prop_guess_hit_stim_pairwise <- 
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_hit_stim_pairwise)
      exp1__pics_words_guess_hit_ttest <- exp1__apa_anova_prop_guess_hit_stim_pairwise$full %>%
          str_remove("^(?:[^\\$]*\\$){6}([^\\$]*)")
##    Pairwise (resp_option-option):
...
##    Pairwise (interaction):
      ...
      exp1__apa_anova_prop_guess_hit_interaction_pairwise_resp_optionoption <-
          papaja:::apa_print.emmGrid(exp1__anova_prop_guess_hit_interaction_pairwise_resp_optionoption)
#------------------------------------------------------------------------------------------------------------------
#   Interaction figure:
#------------------------------------------------------------------------------------------------------------------
