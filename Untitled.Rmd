...
##  Rec:
    exp6__drawing.only__d.prime.rec <- exp6__test.stats %>%
        ...
        mutate(d.prime__drawing.only = qnorm(prop.hit.R__drawing.only) - qnorm(prop.FA.R__drawing.only)) %>%
        select(id, d.prime__drawing.only)
##  Fam:
    exp6__drawing.only__d.prime.fam <- exp6__test.stats %>%
        ...
        mutate(d.prime__drawing.only = qnorm(prop.hit.F__drawing.only) - qnorm(prop.FA.F__drawing.only)) %>%
        select(id, d.prime__drawing.only)
##  Guess:
    exp6__drawing.only__d.prime.guess <- exp6__test.stats %>%
        ...
        mutate(d.prime__drawing.only = qnorm(prop.hit.G__drawing.only) - qnorm(prop.FA.G__drawing.only)) %>%
        select(id, d.prime__drawing.only)
#----------------------------------------------------------------------------------------------------------------  ##  Photos only:      
##  Overall:
...
##  Rec:
    exp6__photo.only__d.prime.rec <- exp6__test.stats %>%
        ...
        mutate(d.prime__photo.only = qnorm(prop.hit.R__photo.only) - qnorm(prop.FA.R__photo.only)) %>%
        select(id, d.prime__photo.only)
##  Fam:
    exp6__photo.only__d.prime.fam <- exp6__test.stats %>%
        ...
        mutate(d.prime__photo.only = qnorm(prop.hit.F__photo.only) - qnorm(prop.FA.F__photo.only)) %>%
        select(id, d.prime__photo.only)
##  Guess:
    exp6__photo.only__d.prime.guess <- exp6__test.stats %>%
        ...
        mutate(d.prime__photo.only = qnorm(prop.hit.G__photo.only) - qnorm(prop.FA.G__photo.only)) %>%
        select(id, d.prime__photo.only)
#----------------------------------------------------------------------------------------------------------------  ##  Drawing plus word:      
##  Overall:
...
##  Add new d'prime calculations to 'exp6__test.stats' df: 
    exp6__test.stats <- exp6__test.stats %>%
